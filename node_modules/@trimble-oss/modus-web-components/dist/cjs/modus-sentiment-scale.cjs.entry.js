...
const IconSmileySatisfiedOutline = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-smiley-satistied-outline ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none" },
...
const IconSmileySatisfied = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-smiley-satistied ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none" },
...
const IconSmileySomewhatSatisfiedOutline = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-smiley-somewhat-satistied-outline ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none" },
...
const IconSmileySomewhatSatisfied = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-smiley-somewhat-satistied ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none" },
...
const IconSmileyNeutralOutline = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-smiley-neutral-outline ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none" },
...
const IconSmileyNeutral = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-smiley-neutral ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none" },
...
const IconSmileySomewhatDissatisfiedOutline = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-smiley-somewhat-dissatistied-outline ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none" },
...
const IconSmileySomewhatDissatisfied = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-smiley-somewhat-dissatistied ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none" },
...
const IconSmileyDissatisfiedOutline = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-smiley-dissatistied-outline ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none" },
...
const IconSmileyDissatisfied = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-smiley-dissatistied ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none" },
...
const IconThumbsDownOutlined = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-thumbs-down-outlined ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '14', height: (_b = props.size) !== null && _b !== void 0 ? _b : 14, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none" },
        index.h("path", { d: "M21.99 12.15c0 1.85-1.5 3.35-3.35 3.35h-3.69c.21 1.88.16 4.52-2.64 5.65-.38.15-.76.23-1.13.23-.76 0-1.44-.32-1.93-.9-.92-1.1-.73-2.61-.65-3 .09-.56-.31-1.06-1.16-2.01-.16-.18-.32-.35-.47-.53-.44.38-1.01.6-1.63.6h-.83a2.5 2.5 0 0 1-2.5-2.5V5.53a2.5 2.5 0 0 1 2.5-2.5h.83c.76 0 1.45.34 1.91.88.6-.56 1.4-.9 2.28-.9h7.06c1.99 0 2.8 1.08 3.49 2.91.6 1.44 1.59 3.81 1.69 4.03.1.22.28.62.22 2.21ZM6.17 5.52c0-.46-.38-.83-.83-.83h-.83c-.46 0-.83.37-.83.83v7.51c0 .46.37.83.83.83h.83c.46 0 .83-.38.83-.83V5.52Zm14.07 5.11c-.12-.26-1.71-4.08-1.71-4.08-.63-1.65-1.02-1.88-1.95-1.88H9.52c-.93 0-1.68.75-1.68 1.68v6.53s-.01.45.1.61c.99 1.27 2.59 2.42 2.31 4.23-.18.99.14 2.38 1.45 1.87 2.29-.93 1.64-3.46 1.39-5.35.03-.22.32-.33.72-.38h.04c.18-.02.37-.03.58-.03h4.2c.93 0 1.68-.75 1.68-1.68 0 0 .05-1.26-.07-1.52Z", fill: (_c = props.color) !== null && _c !== void 0 ? _c : 'currentColor' })));
};

// eslint-disable-next-line
const IconThumbsDown = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-thumbs-down ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none" },
...
const SentimentIconMap = (props) => {
    switch (props.icon) {
        case 'smiley-satisfied-outlined':
            return index.h(IconSmileySatisfiedOutline, { color: props.color, onClick: props.onClick, size: props.size });
        case 'smiley-satisfied':
            return index.h(IconSmileySatisfied, { color: props.color, onClick: props.onClick, size: props.size });
        case 'smiley-somewhat-satisfied-outlined':
            return index.h(IconSmileySomewhatSatisfiedOutline, { color: props.color, onClick: props.onClick, size: props.size });
        case 'smiley-somewhat-satisfied':
            return index.h(IconSmileySomewhatSatisfied, { color: props.color, onClick: props.onClick, size: props.size });
        case 'smiley-neutral-outlined':
            return index.h(IconSmileyNeutralOutline, { color: props.color, onClick: props.onClick, size: props.size });
        case 'smiley-neutral':
            return index.h(IconSmileyNeutral, { color: props.color, onClick: props.onClick, size: props.size });
        case 'smiley-somewhat-dissatisfied-outlined':
            return index.h(IconSmileySomewhatDissatisfiedOutline, { color: props.color, onClick: props.onClick, size: props.size });
        case 'smiley-somewhat-dissatisfied':
            return index.h(IconSmileySomewhatDissatisfied, { color: props.color, onClick: props.onClick, size: props.size });
        case 'smiley-dissatisfied-outlined':
            return index.h(IconSmileyDissatisfiedOutline, { color: props.color, onClick: props.onClick, size: props.size });
        case 'smiley-dissatisfied':
            return index.h(IconSmileyDissatisfied, { color: props.color, onClick: props.onClick, size: props.size });
        case 'thumbs-up-outlined':
            return index.h(IconThumbsUpOutlined, { color: props.color, onClick: props.onClick, size: props.size });
        case 'thumbs-up':
            return index.h(IconThumbsUp, { color: props.color, onClick: props.onClick, size: props.size });
        case 'thumbs-down-outlined':
            return index.h(IconThumbsDownOutlined, { color: props.color, onClick: props.onClick, size: props.size });
        case 'thumbs-down':
            return index.h(IconThumbsDown, { color: props.color, onClick: props.onClick, size: props.size });
    }
};

const modusSentimentScaleCss = ":host{display:block}.sentiment-scale-container{color:var(--modus-sentiment-scale-bg);cursor:pointer;display:flex;flex-shrink:0}.sentiment-scale-container .selected{color:var(--modus-sentiment-scale-selected-bg)}.sentiment-scale-container .smileys-container{display:flex;margin-left:10px;margin-right:10px}.sentiment-scale-container .thumbs-container{display:flex;margin-left:10px;margin-right:10px}.sentiment-scale-container[aria-disabled=true]{pointer-events:none}.sentiment-scale-container .disabled{opacity:var(--modus-sentiment-scale-disabled-opacity)}.sentiment-scale-container .disabled svg:hover path{fill:revert-layer !important}.sentiment-scale-container .disabled .active svg:hover path{fill:revert-layer !important}.sentiment-scale-container .active svg:hover path{color:var(--modus-sentiment-scale-hover-bg)}.sentiment-scale-container svg:focus path{color:var(--modus-sentiment-scale-hover-bg)}.sentiment-scale-container svg:hover path{color:var(--modus-sentiment-scale-hover-bg)}";
const ModusSentimentScaleStyle0 = modusSentimentScaleCss;

const ModusSentimentScale = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.sentimentSelection = index.createEvent(this, "sentimentSelection", 7);
    ...
    render() {
        ...
        return (index.h("div", { key: 'e968794f6f3dfec966d95b4c38bee83cfc289424', class: "sentiment-scale-container", "aria-disabled": this.disabled ? 'true' : undefined, "aria-label": this.ariaLabel || undefined, role: "group" }, iconsMap &&
            Array.from(iconsMap).map(([key, value]) => {
                ...
                return (index.h("div", { "aria-label": value, "aria-selected": isIconSelected ? isIconSelected.toString() : undefined, role: "button", tabIndex: tabIndexValue, class: containerClass, onClick: () => this.handleSentimentClick(key), onKeyDown: (event) => this.handleKeyDown(event, key) }, index.h(SentimentIconMap, { icon: iconName, size: `${this.type === THUMB_SENTIMENT_TYPE ? '32' : '24'}` })));
            })));
    }
};
ModusSentimentScale.style = ModusSentimentScaleStyle0;

exports.modus_sentiment_scale = ModusSentimentScale;
