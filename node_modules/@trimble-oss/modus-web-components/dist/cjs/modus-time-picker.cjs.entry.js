...
const ModusTimePicker = class {
    ...
    renderSubText() {
        return this.errorText ? (index.h("label", { class: "sub-text error" }, this.errorText)) : this.validText ? (index.h("label", { class: "sub-text valid" }, this.validText)) : null;
    }
    render() {
        return (index.h("div", { key: '71008b0018f20b54be6f03bec3e44fdd58b53ca3', class: { 'modus-time-picker': true, disabled: this.disabled } }, index.h("div", { key: 'ac10adff6569fa39cb15d744a9b63f67a16864b3', class: "time-input-wrapper" }, this.label || this.required ? (index.h("div", { class: 'label-container' }, this.label ? index.h("label", { htmlFor: "time-input" }, this.label) : null, this.required ? index.h("span", { class: "required" }, "*") : null, this.helperText ? index.h("label", { class: "sub-text helper" }, this.helperText) : null)) : null, index.h("div", { key: 'f3efd7529da17c4599848ab9981fcc29927562fb', class: `input-container ${this.errorText ? 'error' : this.validText ? 'valid' : ''} ${this.classBySize.get(this.size)}` }, this.renderTimeInput()), this.renderSubText()), index.h("div", { key: '92c585ff751568f97f6eb5ca48d19e83bb2fb61c', class: "time-zone-wrapper" }, index.h("slot", { key: 'd8ab08e4a10507df62951f4cb06692523105583f', name: "timeZone" }))));
    }
