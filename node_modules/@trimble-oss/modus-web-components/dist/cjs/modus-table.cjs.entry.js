...
const modusTable_constants = require('./modus-table.constants-5ff8d50a.js');
const ModusIconMap = require('./ModusIconMap-4076f8df.js');
const tableCellNavigation_utility = require('./table-cell-navigation.utility-2c40c4d6.js');
...
const IconArrowDown = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-arrow-down ${props.pressed ? 'pressed' : ''}`, fill: (_a = props.color) !== null && _a !== void 0 ? _a : 'currentColor', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick, viewBox: "0 0 24 24", width: (_c = props.size) !== null && _c !== void 0 ? _c : 16 },
...
const IconArrowUp = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-arrow-up ${props.pressed ? 'pressed' : ''}`, "data-test-id": "iconArrowUp", fill: (_a = props.color) !== null && _a !== void 0 ? _a : 'currentColor', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick, viewBox: "0 0 24 24", width: (_c = props.size) !== null && _c !== void 0 ? _c : 16 },
...
function getTranslations() {
    const lang = document.documentElement.lang || (navigator === null || navigator === void 0 ? void 0 : navigator.language);
    if (translationStore[lang]) {
        translations = translationStore[lang];
    }
    else {
        const baseLang = lang === null || lang === void 0 ? void 0 : lang.split('-')[0];
...
const ModusTablePagination = ({ context: { tableInstance: table, pageSizeList, data, manualPaginationOptions }, }) => {
    ...
    return (index.h("div", { class: "pagination-container" },
        index.h("div", { class: "items-per-page" },
            index.h("span", null, translate('pageView')),
            index.h("modus-select", { ariaLabel: "Select page size", "options-display-prop": "display", options: optionsList, placeholder: translate('pleaseSelect'), onValueChange: handleChange, value: selectedPageSize })),
        index.h("div", { class: "pagination-and-count" },
            index.h("div", { class: "total-count" },
                index.h("span", null, translate('showingResult')),
                ...
                index.h("span", null, translate('of')),
                index.h("span", null, !options.manualPagination && options.paginateExpandedRows ? getExpandedRowModel().rows.length : totalCount),
                ' '),
            index.h("modus-pagination", { "active-page": pageIndex + 1, "max-page": getPageCount(), "min-page": 1, onPageChange: (event) => setPageIndex(event.detail - 1) }))));
};
...
const ModusTableFooter = ({ context: { tableInstance: { getFooterGroups }, data, density, rowSelection, frozenColumns, rowActions, }, }) => {
    ...
    return (index.h("tfoot", null, getFooterGroups().map((group) => (index.h("tr", { class: "summary-row" },
        rowSelection && (index.h("td", { id: modusTable_constants.COLUMN_DEF_ROW_SELECTION_ID, key: modusTable_constants.COLUMN_DEF_ROW_SELECTION_ID, class: modusTable_constants.COLUMN_DEF_ROW_SELECTION_CSS + ' ' + checkboxSize })),
        group.headers.map((header) => (index.h("td", { id: header.id, key: header.id, class: `
              ...
              ` }, header.column.columnDef[modusTable_constants.COLUMN_DEF_SHOWTOTAL] ? calculateTotal(data, header) : header.column.columnDef.footer))),
        rowActions.length > 0 && index.h("td", null))))));
};
...
class TableHeaderDragDrop {
    ...
    updateNodeAndDragState(clientX, clientY) {
        ...
        const dropColumnId = node && node.getAttribute(modusTable_constants.HTML_ATTR_DATA_ACCESSOR_KEY);
...
class ModusTableCore {
    constructor(tableOptions) {
        var _a;
        this.tableCore = null;
        const { data, columns, columnResize, sort, pagination, preSelectedRows, rowSelection, rowsExpandable, rowSelectionOptions, columnOrder, pageSizeList, toolbarOptions, manualPagination, pageCount, manualSorting, sortingState, defaultSort, currentPageSize, getRowId, setExpanded, setSorting, setRowSelection, setPagination, setColumnSizing, setColumnSizingInfo, setColumnVisibility, setColumnOrder, } = tableOptions;
        ...
        const options = Object.assign(Object.assign({ autoResetPageIndex: false, data: data !== null && data !== void 0 ? data : [], columns: (_a = columns) !== null && _a !== void 0 ? _a : [], state: {
                ...
                pagination: {
                    pageIndex: 0,
                    pageSize: pagination || rowsExpandable ? (currentPageSize ? currentPageSize : pageSizeList[0]) : data === null || data === void 0 ? void 0 : data.length,
                },
...
const ModusTableColumnResizingHandler = ({ table, header, onMouseEnter, onMouseLeave, }) => {
    return (index.h("div", null,
        index.h("div", { tabIndex: 0, onMouseDown: header.getResizeHandler(), onTouchStart: header.getResizeHandler(), onKeyDown: throttle(table, header.column), onMouseEnter: () => onMouseEnter(), onMouseLeave: () => onMouseLeave(), class: "resize-handle" }),
        index.h("div", { class: "resize-handle-border" })));
};
...
function renderSortIcon(direction, style) {
    ...
    return index.h(ModusIconMap.ModusIconMap, { icon: icon, size: ICON_SIZE });
}
/**
...
const ModusTableColumnHeaderLabel = ({ column, isColumnResizing, sortIconStyle, showSortIconOnHover, }) => {
    ...
    const HeaderText = () => {
        ...
        return (index.h("modus-tooltip", { class: "column-title", text: sortingStatus },
            index.h("span", Object.assign({}, containerProps, { class: `header-text ${canSort && isSorted ? 'sorted' : ''}` }), column.columnDef.header)));
    };
    const SortIcon = () => {
        if (!canSort) {
            return null;
        }
        return (index.h("modus-tooltip", { class: "modus-tooltip-sort-icon", text: sortingStatus, position: "bottom" },
            index.h("span", Object.assign({}, containerProps, { tabindex: "0", class: "sort-icon-container" }),
                index.h("span", { class: `sort-icon ${!isSorted && 'disabled'} ${showSortIconOnHover ? 'hidden' : ''}` }, renderSortIcon(isSorted, sortIconStyle)))));
    };
    return (index.h("span", { class: canSort && 'can-sort' },
        index.h(HeaderText, null),
        index.h(SortIcon, null)));
};
...
const ModusTableColumnHeader = ({ id, context, header, isNestedParentHeader, onDragStart, onMouseEnterResize, onMouseLeaveResize, }) => {
    ...
    return (index.h("th", { "data-accessor-key": headerId, tabindex: `${isColumnResizing ? '' : '0'}`, key: id, colSpan: colSpan, "aria-sort": getSortingStatus(column, isColumnResizing), 
        /**
      ...
      `, style: {
        ...
        index.h(ModusTableColumnHeaderLabel, { isColumnResizing: isColumnResizing, showSortIconOnHover: showSortIconOnHover, sortIconStyle: sortIconStyle, column: column })),
...
const ModusTableHeaderCheckbox = ({ context }) => {
    ...
    return (index.h("th", { class: 'row-checkbox sticky-left ' + checkboxSize, style: { width: width } }, (rowSelectionOptions === null || rowSelectionOptions === void 0 ? void 0 : rowSelectionOptions.multiple) && (index.h("modus-checkbox", { ariaLabel: "Select all rows", checked: getIsAllRowsSelected(), indeterminate: getIsSomeRowsSelected(), size: checkboxSize, onCheckboxClick: getToggleAllRowsSelectedHandler() }))));
};

const ModusTableHeader = ({ context, onDragStart, getColumnResizing, setColumnResizing, }) => {
    const { tableInstance: { getHeaderGroups }, columnReorder, rowSelection, componentId, rowActions, rowActionSize, rowActionHeader, } = context;
    const tableHeadClass = { 'show-resize-cursor': getColumnResizing(), 'show-column-reorder-cursor': columnReorder };
    const headerGroups = getHeaderGroups();
    const rowActionsLength = rowActionSize && rowActionSize >= 40 ? rowActionSize : Math.min(Math.max(rowActions.length * 40, 90), 160);
    const rowActionsHeader = rowActionHeader ? rowActionHeader : 'Row Actions Column';
    const rowActionsConfig = { header: rowActionsHeader, width: rowActionsLength };
    return (index.h("thead", { class: tableHeadClass }, headerGroups === null || headerGroups === void 0 ? void 0 : headerGroups.map((headerGroup, index$1) => {
        var _a;
        return (index.h("tr", { key: headerGroup.id },
            rowSelection && index.h(ModusTableHeaderCheckbox, { context: context }), (_a = headerGroup.headers) === null || _a === void 0 ? void 0 :
            _a.map((header) => {
                const id = `${componentId}-${header.id}`;
                return (index.h(ModusTableColumnHeader, { id: id, context: context, header: header, isNestedParentHeader: index$1 < headerGroups.length - 1, onDragStart: onDragStart, onMouseEnterResize: () => setColumnResizing(true), onMouseLeaveResize: () => setColumnResizing(false) }));
            }),
            rowActions.length > 0 && (index.h("th", { class: "sticky-right", style: { width: `${rowActionsConfig.width}px` } }, rowActionsConfig.header))));
    })));
};
...
const ModusTableCell = ({ cell, cellIndex, context, valueChange }) => {
    ...
    const { id } = cell;
    return (index.h("td", { key: id, tabindex: 0, class: `
      ${hasRowsExpandable || frozenColumns.includes(cell.column.id) ? 'sticky-left' : ''}
      ${cell.column.getIsResizing() ? 'active-resize' : ''}
  `, style: { width: `${cell.column.getSize()}px` } },
        index.h("modus-table-cell-main", { cell: cell, hasRowsExpandable: hasRowsExpandable, context: context, valueChange: valueChange })));
};

const ModusTableCellCheckbox = ({ multipleRowSelection, row, isChecked, checkboxSize, updateRow, disableRow, }) => {
    let cellEl = null;
    let checkboxInput = null;
    function handleKeyDown(e) {
        if (e.key.toLowerCase() === modusTable_constants.KEYBOARD_ENTER) {
            e.stopPropagation();
            return;
        }
        tableCellNavigation_utility.NavigateTableCells({
            eventKey: e.key,
            cellElement: cellEl,
        });
    }
    function handleCheckboxKeyDown(e) {
        if (disableRow)
            return;
        if (e.key.toLowerCase() === modusTable_constants.KEYBOARD_ENTER || e.key.toLowerCase() === modusTable_constants.KEYBOARD_SPACE) {
            e.preventDefault();
            updateRow();
        }
    }
    return (index.h("td", { class: 'row-checkbox sticky-left ' + (checkboxSize !== null && checkboxSize !== void 0 ? checkboxSize : ''), tabIndex: 0, ref: (el) => (cellEl = el), onFocus: () => checkboxInput === null || checkboxInput === void 0 ? void 0 : checkboxInput.focusCheckbox(), onKeyDown: (e) => handleKeyDown(e) },
        index.h("modus-checkbox", { ariaLabel: "Select row", ref: (el) => (checkboxInput = el), checked: isChecked, indeterminate: multipleRowSelection && row.getIsSomeSelected(), size: checkboxSize, disabled: disableRow, onKeyDown: (e) => handleCheckboxKeyDown(e) })));
};
...
const ModusTableBody = ({ context }) => {
    ...
    function handleCellValueChange(props) {
        ...
        updateData((old) => {
            ...
            if (idArray.length === 1) {
                ...
                newData[idArray[0]][modusTable_constants.COLUMN_DEF_SUB_ROWS_KEY][idArray[1]][accessorKey] = newValue;
            }
            else if (idArray.length === 3) {
                newData[idArray[0]][modusTable_constants.COLUMN_DEF_SUB_ROWS_KEY][idArray[1]][modusTable_constants.COLUMN_DEF_SUB_ROWS_KEY][idArray[2]][accessorKey] =
                    newValue;
            }
            return newData;
    ...
    return (index.h("tbody", null, (_a = table.getRowModel()) === null || _a === void 0 ? void 0 : _a.rows.map((row) => {
        var _a;
...
const ModusTable = class {
    constructor(hostRef) {
        ...
        this.columnOrderChange = index.createEvent(this, "columnOrderChange", 7);
        this.columnSizingChange = index.createEvent(this, "columnSizingChange", 7);
        this.columnVisibilityChange = index.createEvent(this, "columnVisibilityChange", 7);
        this.rowActionClick = index.createEvent(this, "rowActionClick", 7);
        this.rowExpanded = index.createEvent(this, "rowExpanded", 7);
        ...
        this.rowActions = [];
        this.rowActionsConfig = undefined;
        ...
        this.wrapText = false;
        this.rowSelectionDisabled = undefined;
    ...
    onColumnsChange(newVal) {
        ...
        (_c = this.tableCore) === null || _c === void 0 ? void 0 : _c.setState('columnOrder', newVal.map((column) => column.id));
        this.tableState.columnOrder = newVal.map((column) => column.id);
    }
    ...
    onDataChange(newVal) {
        ...
        if (!this.manualPaginationOptions) {
            (_a = this.tableCore) === null || _a === void 0 ? void 0 : _a.setState('pagination', Object.assign(Object.assign({}, this.tableState.pagination), { pageIndex: this.tableState.pagination.pageIndex, pageSize: this.pagination
    ...
    componentWillLoad() {
        var _a, _b, _c;
        this._id = this.element.id || `modus-table-${utils.createGuid()}`;
     ...
     */
    async toggleAllRowsSelection(select) {
    ...
    getRowActionsWithOverflow() {
        ...
        if (this.rowActions) {
            ...
            if ((_a = this.rowActionsConfig) === null || _a === void 0 ? void 0 : _a.menuOnly) {
                return sortedActions.map((action) => (Object.assign(Object.assign({}, action), { isOverflow: true })));
            }
    ...
    getTableContext() {
        ...
        return {
            ...
            rowActionSize: (_a = this.rowActionsConfig) === null || _a === void 0 ? void 0 : _a.width,
            rowActionHeader: (_b = this.rowActionsConfig) === null || _b === void 0 ? void 0 : _b.header,
    ...
    initializeTable() {
        var _a, _b;
        this.tableCore = new ModusTableCore(Object.assign(Object.assign(Object.assign({ data: (_a = this.data) !== null && _a !== void 0 ? _a : [], columns: this.columns, columnResize: this.columnResize, sort: this.sort, pagination: this.pagination, rowsExpandable: this.rowsExpandable, pageSizeList: this.pageSizeList, rowSelection: this.rowSelection, rowSelectionOptions: this.rowSelectionOptions, columnOrder: this.columnReorder ? this.tableState.columnOrder : [], toolbarOptions: this.toolbarOptions, preSelectedRows: this.getPreselectedRowState(), defaultSort: this.defaultSort, currentPageSize: (_b = this.manualPaginationOptions) === null || _b === void 0 ? void 0 : _b.currentPageSize }, (this.manualPaginationOptions && {
            ...
            setExpanded: (updater) => this.updateTableCore(updater, modusTable_constants.EXPANDED_STATE_KEY, this.rowExpanded), setSorting: (updater) => this.updateTableCore(updater, modusTable_constants.SORTING_STATE_KEY, this.sortChange), setRowSelection: (updater) => this.updateRowSelection(updater), setPagination: (updater) => this.updateTableCore(updater, modusTable_constants.PAGINATION_STATE_KEY, this.paginationChange), setColumnSizing: (updater) => this.updateTableCore(updater, modusTable_constants.COLUMN_SIZING_STATE_KEY, this.columnSizingChange), setColumnSizingInfo: (updater) => this.updateColumnSizingInfo(updater), setColumnVisibility: (updater) => this.updateTableCore(updater, modusTable_constants.COLUMN_VISIBILITY_STATE_KEY, this.columnVisibilityChange), setColumnOrder: (updater) => {
                this.updateTableCore(updater, modusTable_constants.COLUMN_ORDER_STATE_KEY);
            } }));
    }
    setTableState(state) {
    ...
    updateRowSelection(updater) {
        this.updateTableCore(updater, modusTable_constants.ROW_SELECTION_STATE_KEY);
    ...
    updateColumnSizingInfo(updater) {
        this.updateTableCore(updater, modusTable_constants.COLUMN_SIZING_INFO_STATE_KEY);
        this.isColumnResizing = !this.tableState.columnSizingInfo.isResizingColumn ? false : true;
    }
    renderToolBar() {
        return (this.toolbar &&
            this.toolbarOptions && (index.h("modus-table-toolbar", { context: this._context }, index.h("div", { slot: "group-left" }, index.h("slot", { name: "groupLeft" })), index.h("div", { slot: "group-right" }, index.h("slot", { name: "groupRight" })))));
    }
    renderMain() {
        ...
        return (index.h(index.Fragment, null, index.h("div", { class: tableContainerClass, style: { maxHeight: this.maxHeight } }, this.renderTable(), !this.fullWidth && (index.h("modus-table-filler-column", { container: this.element, "summary-row": this.summaryRow, "cell-borderless": cellBorderless }))), index.h("slot", { name: "customFooter" })));
    }
    renderTable() {
        var _a, _b, _c;
      ...
      ${((_c = this.displayOptions) === null || _c === void 0 ? void 0 : _c.cellVerticalBorderless) ? 'cell-vertical-borderless' : ''}
    ...
    `;
        const tableStyle = this.fullWidth
            ...
            : totalSize > 0
                ...
                : { tableLayout: 'fixed' };
        return (index.h("table", { "data-test-id": "main-table", class: tableMainClass, style: tableStyle }, this.renderTableHeader(), this.renderTableBody(), this.renderTableFooter()));
    }
    renderTableHeader() {
        ...
        return (index.h(ModusTableHeader, { context: this._context, setColumnResizing: setColumnResizing, getColumnResizing: getColumnResizing, onDragStart: onDragStart }));
    }
    renderTableBody() {
        return index.h(ModusTableBody, { context: this._context });
    }
    renderTableFooter() {
        return this.summaryRow ? index.h(ModusTableFooter, { context: this._context }) : null;
    }
    renderPagination() {
        return this.pagination && index.h(ModusTablePagination, { context: this._context });
    }
    render() {
        var _a;
        return (index.h(index.Host, { key: 'b0a13e34ef5f00b38444bca8bc5193c3032a96f8', id: this._id }, index.h("div", { key: '41fb8cc396890e63431d3d851a84181c338977f9', style: { maxWidth: this.maxWidth } }, this.renderToolBar(), this.renderMain(), this.renderPagination(), index.h(ModusTableColumnDragItem, { key: '6e28094e11b7446b82b83d3ecd0a92c45b5d7767', draggingState: this.itemDragState }), index.h(ModusTableColumnDropIndicator, { key: '4b2b34a68f4527244eefc436fdaac4631635c7b3', position: (_a = this.itemDragState) === null || _a === void 0 ? void 0 : _a.dropIndicator }), index.h("modus-table-row-actions-menu", { key: '8440d7ac598601cf22f2420220c4058705754cc1', context: this._context }))));
    }
