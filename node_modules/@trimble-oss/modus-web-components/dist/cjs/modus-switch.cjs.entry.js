...
const ModusSwitch = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'a2c1ffca3dd9a0626c86310f8ef17470be42c77d', class: containerClassName, onClick: () => this.handleSwitchClick(), tabIndex: this.disabled ? -1 : 0 }, index.h("div", { key: '0341cd2fa1d3bb27d1b4f9a06146b2fec9f1d77e', class: switchClassName }, index.h("span", { key: '3df28b362be186265eb6336949c6bbc17962afe0', class: `slider` })), index.h("input", { key: 'bb410e504919d45853e2e828b0acfce2168706ed', "aria-checked": String(this.checked), "aria-disabled": this.disabled ? 'true' : undefined, "aria-label": this.ariaLabel || undefined, checked: this.checked, disabled: this.disabled, ref: (el) => (this.checkboxInput = el), role: "switch", type: "checkbox" }), this.label ? index.h("label", null, this.label) : null));
    }
};
