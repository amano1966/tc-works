...
const IconSortAZ = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { "data-test-id": "iconSortAZ", class: `${props.pressed ? 'pressed' : ''}`, fill: (_a = props.color) !== null && _a !== void 0 ? _a : 'currentColor', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick, viewBox: "0 0 32 32", width: (_c = props.size) !== null && _c !== void 0 ? _c : 16 },
...
const IconSortZA = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { "data-test-id": "iconSortZA", class: `${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : 16, height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, fill: (_c = props.color) !== null && _c !== void 0 ? _c : 'currentColor', onClick: props.onClick, viewBox: "0 0 32 32" },
...
const ModusDataTableHeader = (props) => {
    const sortIcon = props.sortState.direction !== 'none' ? (index.h("modus-tooltip", { position: "bottom", text: `${props.sortState.direction === 'asc' ? 'Sort descending' : 'Remove sort'}` },
        index.h("div", { class: "icon-container" },
            index.h("div", { class: "sort-icon" }, props.sortState.direction === 'asc' ? index.h(IconSortAZ, { size: '16' }) : index.h(IconSortZA, { size: '16' }))))) : null;
...
const ModusDataTableRowActionDropdown = (props) => {
    return (index.h("modus-dropdown", { "toggle-element-id": `dropdownToggle-${props.rowId}`, "animate-list": props.animateDropdown, customPlacement: { left: -194 }, showDropdownListBorder: false },
        index.h("div", { class: "row-action", id: `dropdownToggle-${props.rowId}`, slot: "dropdownToggle" },
            index.h(ModusIconMap.ModusIconMap, { icon: "more_vertical", size: "24" })),
            ...
            index.h("div", { class: "list-container" },
                index.h("div", { class: "items-container" }, props.actions.map((action) => (index.h("div", { class: "action-item", onClick: () => props.onRowActionClick(action._id, props.rowId) },
                    index.h("div", { class: "action-item-content" },
                        action.display.icon && index.h(ModusIconMap.ModusIconMap, { icon: action.display.icon, size: '16' }),
...
const ModusDataTable = class {
    ...
    `;
        return (index.h("table", { key: 'd53f299f917ec5f6c4e0fb053c52d12a7d94ed02', class: className }, index.h("colgroup", { key: '8435c07dd1c6754ebbca29ba1967c063cf6ffdfd' }, this.selectionOptions.canSelect && this.selectionOptions.checkboxSelection && index.h("col", { style: { width: '34px' } }), (_a = this.columns) === null || _a === void 0 ? void 0 :
            _a.map((column) => (index.h("col", { style: { width: column.width } }))), !!this.rowActions.length && index.h("col", { style: { width: '34px' } })), index.h("thead", { key: 'c098e976be8cca8ee699776744fa8804a3bc2803' }, index.h("tr", { key: '5be24af7e8e9a1cee430a683f7c79e2b3cc552ea' }, this.selectionOptions.canSelect && this.selectionOptions.checkboxSelection && (index.h("th", null, index.h("div", { class: "column-header align-center" }, index.h("modus-checkbox", { checked: this.allSelected, onCheckboxClick: (e) => this.handleHeaderCheckboxClick(e.detail) })))), (_b = this.columns) === null || _b === void 0 ? void 0 :
            _b.map((column) => (index.h(ModusDataTableHeader, { column: column, onColumnHeaderClick: (id) => this.handleColumnHeaderClick(id), sortOptions: this.sortOptions, sortState: this.sortState }))), !!this.rowActions.length && index.h("th", null))), index.h("tbody", { key: 'cd8d983d7d804f126285ffa915c7910ff00b11b2' }, (_c = this.data) === null || _c === void 0 ? void 0 : _c.map((row) => {
            var _a;
...
ModusDataTable.style = ModusDataTableStyle0;
