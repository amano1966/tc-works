...
const ModusButtonGroup = class {
    constructor(hostRef) {
        ...
        this.buttonGroupClick = index.createEvent(this, "buttonGroupClick", 7);
        this.buttonSelectionChange = index.createEvent(this, "buttonSelectionChange", 7);
    ...
    render() {
        return (index.h(index.Host, { key: 'd8b941eec339bb068a23b6aec06c5e9c49449d31', "aria-label": this.ariaLabel, "aria-disabled": this.ariaDisabled ? this.ariaDisabled : this.disabled ? 'true' : undefined, role: "group" }, index.h("slot", { key: 'f593f0ffe06268419d7da12f8cb8290e7fb01269' })));
    }
...
exports.modus_button_group = ModusButtonGroup;
