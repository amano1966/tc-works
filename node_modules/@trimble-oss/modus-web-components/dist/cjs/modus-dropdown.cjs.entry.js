...
const ModusDropdown = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '2f74879137815b488816cf099d98b3563a440cee', "aria-label": this.ariaLabel || undefined, class: dropdownClass, onClick: (event) => this.handleDropdownClick(event) }, index.h("slot", { key: '57d725248db3285395c099db854176aa4f1c1b36', name: "dropdownToggle" }), index.h("div", { key: '606fbb3cb4d7dc2cf8739295d22324071999602a', class: listContainerClass, part: "dropdownListPanel", style: {
            ...
            } }, index.h("slot", { key: '404c76ba9506b37807e6b03a38c7647a89578163', name: "dropdownList" }))));
    }
