...
const ModusCheckbox = class {
    constructor(hostRef) {
        ...
        this.checkBoxId = utils.generateElementId() + '_checkbox';
    ...
    render() {
        ...
        return (index.h("div", { key: '8a7199d1f8a9a55de7c101b87d7a2496d9659586', class: className }, index.h("input", { key: '9cca6a6b4607cb0aa2c3cda732b54757c4f68277', class: `checkbox ${this.size === 'small' ? 'small' : ''} ${this.disabled ? 'disabled' : ''}`, "aria-disabled": this.disabled ? 'true' : undefined, "aria-label": this.ariaLabel || undefined, checked: this.checked, disabled: this.disabled, id: this.checkBoxId, ref: (el) => (this.checkboxInput = el), onChange: (event) => {
                this.handleCheckboxClick(event);
            }, type: "checkbox" }), this.label ? (index.h("label", { htmlFor: this.checkBoxId, class: ` ${this.disabled ? 'disabled' : ''} ${this.size === 'small' ? 'small' : ''}` }, this.label)) : null));
    }
};
