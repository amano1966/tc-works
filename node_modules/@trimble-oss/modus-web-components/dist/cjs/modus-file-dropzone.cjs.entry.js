...
const IconUploadCloud = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `upload-cloud ${props.pressed ? 'pressed' : ''}`, fill: (_a = props.color) !== null && _a !== void 0 ? _a : 'currentColor', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick, viewBox: "0 0 24 24", width: (_c = props.size) !== null && _c !== void 0 ? _c : 16 },
        index.h("path", { d: "M19.93 11.12c.04-.29.07-.57.07-.87C20 6.8 17.2 4 13.75 4c-2.53 0-4.7 1.5-5.68 3.66-.42-.1-.86-.16-1.32-.16C3.57 7.5 1 10.07 1 13.25S3.57 19 6.75 19H19c2.21 0 4-1.79 4-4a3.99 3.99 0 0 0-3.07-3.88Zm-4.41 1.31h-1.96V17c0 .27-.22.5-.5.5h-2.11c-.27 0-.5-.23-.5-.5v-4.57H8.48c-.23 0-.35-.28-.18-.44l3.35-3.35c.2-.2.51-.2.71 0l3.35 3.35c.16.16.05.44-.18.44Z" })));
};

// eslint-disable-next-line
const IconCancel = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-cancel ${props.pressed ? 'pressed' : ''}`, fill: (_a = props.color) !== null && _a !== void 0 ? _a : 'currentColor', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick, viewBox: "0 0 32 32", width: (_c = props.size) !== null && _c !== void 0 ? _c : 16 },
...
const ModusFileDropzone = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e32075caab6e81297f4a9886ec080a2bd4c49d40', "aria-label": this.ariaLabel, role: "button", "aria-disabled": this.disabled ? 'true' : undefined }, index.h("div", { key: '07f65ed3e45f27a0413da1815a2c1e3e8e6a6c19', class: "modus-file-dropzone" }, index.h("input", { key: '6c66f4a60bd5345bf6bf9115fae5398f96bea3b6', onChange: this.onFileChange, multiple: this.multiple, ref: (el) => (this.fileInput = el), type: "file", disabled: this.disabled, accept: this.acceptFileTypes }), index.h("div", { key: 'f5d2d65fd353a4e0761401a3b03cd10cc34058dd', class: "header" }, index.h("label", { key: '115d3d176add90f4847ccf0197eb09a4293d0839' }, this.label), index.h("span", { key: '5449f73202db22792b542525757fde422ed7ca68' }, this.description)), index.h("div", { key: '39c2eb65ae308cb7642e767ea8d06150cf7fc983', class: {
                dropzone: true,
                error: !!this.error,
                highlight: this.fileDraggedOver,
                disabled: this.disabled,
            }, onDragLeave: (e) => this.onDragLeave(e), onDragOver: (e) => this.onDragOver(e), onDrop: (e) => this.onDrop(e), style: { height: this.dropzoneHeight, width: this.dropzoneWidth }, tabIndex: 0 }, this.includeStateIcon && (this.error ? index.h(IconCancel, { size: '36' }) : index.h(IconUploadCloud, { size: '36' })), !this.error &&
            (this.fileDraggedOver ? (this.fileDraggedOverInstructions) : (index.h("div", { class: "browse", onClick: this.openBrowse }, this.instructions))), this.error && (index.h("div", { class: "error-messages", role: "alert" }, this.errorMessageTop && index.h("span", null, this.errorMessageTop), this.errorMessageBottom && index.h("span", null, this.errorMessageBottom), index.h("modus-button", { "button-style": "outline", color: "secondary", onClick: this.reset }, "Reset")))))));
    }
};
