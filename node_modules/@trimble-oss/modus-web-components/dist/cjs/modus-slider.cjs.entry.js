...
const ModusSlider = class {
    constructor(hostRef) {
        ...
        this.sliderId = utils.generateElementId() + '_slider';
    ...
    render() {
        ...
        return (index.h("div", { key: 'd3b1022ee8577c49f5b45dbe0d950d2afc19dc1d', "aria-disabled": this.disabled ? 'true' : undefined, "aria-label": this.ariaLabel || undefined, class: className, style: { '--value-percent': `${this.valuePercent}%`, marginBottom: '50px', marginTop: '50px' } }, this.label && index.h("label", { htmlFor: this.sliderId }, this.label), index.h("input", { key: 'c0a52b06d4edde6e0a276b9a4d3cf218d0c7e073', class: "slider", disabled: this.disabled, id: this.sliderId, max: this.maxValue, min: this.minValue, onChange: (event) => this.handleOnChange(event), onInput: (event) => this.handleOnInput(event), type: "range", value: this.value })));
    }
