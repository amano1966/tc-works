...
const ModusRadioGroup = class {
    ...
    render() {
        return (index.h("div", { key: 'f739d67545febe34e1b7f1895aafa8b640d8a23f', class: "modus-radio-group", "aria-label": this.ariaLabel }, this.radioButtons.map((radioButton, index$1) => {
            return (index.h(ModusRadioButton, { ref: (el) => (this.radioButtonRefs[index$1] = el), size: this.size, checked: radioButton.checked, disabled: radioButton.disabled, label: radioButton.label, name: this.name, id: radioButton.id, handleButtonClick: (id) => this.handleButtonClick(id), handleKeydown: (event, id) => this.handleButtonKeydown(event, id) }));
        })));
    }
...
ModusRadioGroup.style = ModusRadioGroupStyle0;
