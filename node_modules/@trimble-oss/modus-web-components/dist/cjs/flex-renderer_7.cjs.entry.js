...
const FlexRenderer = class {
    ...
    render() {
        return index.h(index.Host, { key: 'f1d1844c4dc3c40709804bd3c061ad15aec2e0da' });
    }
...
const ModusAutocomplete = class {
    constructor(hostRef) {
        ...
        this.selectionsChanged = index.createEvent(this, "selectionsChanged", 7);
        this.listId = utils.generateElementId() + '_list';
        ...
        this.getHighlightedText = (text, search) => {
            ...
            return index.h("span", { innerHTML: highlightedText });
        };
        // Do not display the slot for the custom options. We use this hidden slot to reference the slot's children.
        this.CustomOptionsSlot = () => (index.h("div", { style: { display: 'none' } }, index.h("slot", { onSlotchange: () => this.updateVisibleCustomOptions(this.getValueAsString()) })));
        this.TextInput = () => (index.h("modus-text-input", { class: "input", autocomplete: "off", includeSearchIcon: false, onFocus: this.handleTextInputFocus, onValueChange: (searchEvent) => this.handleTextInputValueChange(searchEvent), placeholder: this.placeholder, size: this.size, type: "search", value: this.getValueAsString(), onBlur: this.handleInputBlur, onKeyDown: (e) => this.handleInputKeyDown(e), role: "combobox", disabled: this.disabled, readOnly: this.readOnly, "aria-autocomplete": "list", "aria-controls": this.listId, "aria-expanded": this.displayOptions() }));
    ...
    render() {
        ...
        return (index.h("div", { key: '2e1d65aa5f02f1199b0c3e63ed4ab81da41a6062', "aria-disabled": this.disabled ? 'true' : undefined, "aria-invalid": !!this.errorText, "aria-label": this.ariaLabel || undefined, "aria-readonly": this.readOnly ? 'true' : undefined, "aria-required": this.required, class: classes, onFocusin: () => {
                if (this.hasFocus) {
                    return;
                }
                this.hasFocus = true;
            ...
            }, onKeyDown: (e) => this.handleKeyDown(e) }, this.label || this.required ? (index.h("div", { class: 'label-container' }, this.label ? index.h("label", null, this.label) : null, this.required ? index.h("span", { class: "required" }, "*") : null)) : null, index.h("div", { key: 'c11b8a67b60820fb603bb517861083f3e2defb1c', class: `chips-container ${this.clearable ? 'clearable-icon' : ''}` }, this.includeSearchIcon ? index.h(iconSearch.IconSearch, { size: "16" }) : null, this.selectedChips.map((chip) => (index.h("modus-chip", { class: "autocomplete-chip", tabIndex: this.disabled ? -1 : 0, value: chip.value, chipId: chip.id, disabled: this.disabled, onKeyDown: (e) => this.handleChipDelete(e, chip), size: this.size === 'large' ? 'medium' : 'small', "show-close": true, onCloseClick: () => this.handleCloseClick(chip) }))), this.TextInput(), showClearIcon && (index.h("span", { class: "icons clear", tabIndex: 0, onKeyDown: (event) => this.handleClearKeyDown(event), onClick: () => this.handleClear(), role: "button", "aria-label": "Clear entry" }, index.h(iconClose.IconClose, { size: iconSize })))), index.h("div", { key: 'a99555ba4a09030b1e646b2068ab835e16d479ce', class: 'error' }, this.errorText ? index.h("label", { class: "sub-text error" }, this.errorText) : null), index.h("div", { key: 'e3441ad7714adbdea717b2881d94b7a3f1038959', class: "options-container", style: { maxHeight: this.dropdownMaxHeight, zIndex: this.dropdownZIndex, overflowY: 'auto' } }, index.h("ul", { key: '89aeef4adc34adad8f45eeb3b893d2c79e88a2c9', id: this.listId, "aria-label": "options", role: "listbox" }, this.displayOptions() &&
            ((_a = this.visibleOptions) === null || _a === void 0 ? void 0 : _a.map((option) => {
                ...
                return (index.h("li", { class: className, tabindex: "-1", role: "option", onMouseDown: () => this.handleOptionClick(option), onKeyDown: (e) => this.handleOptionKeyDown(e, option) }, this.getHighlightedText(option.value, this.getValueAsString()), isSelected && index.h(ModusIconMap.IconCheck, { size: "16" })));
            })), this.displayOptions() &&
            ((_b = this.visibleCustomOptions) === null || _b === void 0 ? void 0 : _b.map((option) => {
                ...
                return (index.h("li", { class: className, tabindex: "-1", role: "option", onMouseDown: () => this.handleCustomOptionClick(option), onKeyDown: (e) => this.handleOptionKeyDown(e, option, true), innerHTML: option.outerHTML }));
            }))), this.loading ? (index.h(LoadingSpinner, null)) : (this.displayNoResults() && index.h(NoResultsFound, { text: this.noResultsFoundText, subtext: this.noResultsFoundSubtext }))), this.CustomOptionsSlot()));
    }
    get el() { return index.getElement(this); }
...
const LoadingSpinner = () => (index.h("div", { class: "spinner-container" }, index.h("modus-spinner", { size: "1.5rem" })));
...
const ModusDateInput = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.calendarIconClicked = index.createEvent(this, "calendarIconClicked", 7);
        this.dateInputBlur = index.createEvent(this, "dateInputBlur", 7);
        this.valueChange = index.createEvent(this, "valueChange", 7);
        this.valueError = index.createEvent(this, "valueError", 7);
        this.classBySize = new Map([
            ['medium', 'medium'],
            ['large', 'large'],
        ]);
    ...
    render() {
        ...
        return (index.h("div", { key: '11748c327dac4ffd55b82a860d6f4d0dee839de3', class: className }, this.label || this.required ? (index.h("div", { class: "label-container" }, this.label ? index.h("label", { htmlFor: this._dateInputId }, this.label) : null, this.required ? index.h("span", { class: "required" }, "*") : null, this.helperText ? index.h("label", { class: "sub-text helper" }, this.helperText) : null)) : null, index.h("div", { key: 'ebe2014200739e3174a4f606018dbabe79fc0bac', class: `input-container ${displayErrorMessage ? 'error' : this.validText ? 'valid' : ''} ${this.classBySize.get(this.size)}`, part: `input-container ${displayErrorMessage ? 'error' : this.validText ? 'valid' : ''}` }, index.h("input", { key: 'dde7167d78b896a0acb6fe86b57c97ee739fb892', "aria-invalid": !!displayErrorMessage, "aria-label": this.ariaLabel || undefined, "aria-required": (_a = this.required) === null || _a === void 0 ? void 0 : _a.toString(), autofocus: this.autoFocusInput, class: { 'has-right-icon': this.showCalendarIcon }, disabled: this.disabled, id: this._dateInputId, onBlur: () => this.handleBlur(), onInput: (event) => this.handleOnInput(event), onKeyPress: (e) => this.handleInputKeyPress(e), onKeyDown: (e) => this.handleInputKeyDown(e), placeholder: this.placeholder, readonly: this.readOnly, ref: (el) => (this._dateInput = el), tabIndex: 0, type: "text", value: this._dateDisplay }), this.showCalendarIcon && (index.h("span", { class: "icons", tabIndex: 0, onKeyDown: (e) => this.handleDefaultKeyDown(e, () => this.handleCalendarClick()), onClick: () => this.handleCalendarClick(), role: "button", "aria-label": "Open calendar" }, index.h(ModusIconMap.ModusIconMap, { icon: "calendar", size: "16" })))), index.h("div", { key: '18caf62b1f4ccd23bd06b5e25cb0a4b4af0681d5', class: "sub-text", part: "sub-text" }, displayErrorMessage ? (index.h("label", { class: "error" }, displayErrorMessage)) : displayValidMessage ? (index.h("label", { class: "valid" }, this.validText)) : null)));
    }
...
const ModusDatePicker = class {
    ...
    renderCalendarBody() {
        ...
        }))), !this.isWithinCurrentMinMax(this._currentInput.getDate()) && (index.h("div", { class: "out-of-range-notification" }, index.h("div", null, "The selected date is not available"), index.h("span", { class: "goto-available-dates", onClick: () => this.goToNearestBoundaryDate(this._currentInput.getDate()) }, "Go to available dates")))));
    }
    renderCalendarHeader() {
        var _a, _b;
        return (index.h("div", { class: "calendar-header" }, index.h("button", { type: "button", "aria-label": "Previous Month", onClick: () => this.addMonthOffset(-1) }, index.h(ModusIconMap.ModusIconMap, { icon: "chevron_left_bold" })), index.h("div", { class: "title" }, index.h("div", { class: "calendar-title", role: "heading" }, `${(_a = this._calendar) === null || _a === void 0 ? void 0 : _a.month} ${(_b = this._calendar) === null || _b === void 0 ? void 0 : _b.year}`), index.h("div", { class: "year-icons" }, index.h("button", { type: "button", tabIndex: 0, "aria-label": "Next Year", onClick: () => this.addYearOffset(1), class: "year-up" }, index.h(ModusIconMap.ModusIconMap, { icon: "caret_up", size: "16" })), index.h("button", { type: "button", tabIndex: 0, "aria-label": "Previous Year", onClick: () => this.addYearOffset(-1), class: "year-down" }, index.h(ModusIconMap.ModusIconMap, { size: "16", icon: "caret_down" })))), index.h("button", { type: "button", tabIndex: 0, "aria-label": "Next Month", onClick: () => this.addMonthOffset(1) }, index.h(ModusIconMap.ModusIconMap, { icon: "chevron_right_bold" }))));
    }
    render() {
        return (index.h("div", { key: '296f45926a5e4e7faf415fafa9ad149c56661f9e', class: "modus-date-picker" }, this.label ? index.h("div", { class: 'label-container' }, this.label ? index.h("label", null, this.label) : null) : null, index.h("div", { key: '7ac0f29be1e1ad25531a24714dd520050c7d4604', class: "date-inputs", part: "date-inputs" }, index.h("slot", { key: 'b40cf940b60aa59f452b2da88e07bd8ebb5d418b', onSlotchange: () => this.handleSlotChange() })), index.h("div", { key: 'fc6cb1a09499860ae721fc96b757fb67f67a4fc7', class: "calendar", part: "calendar", style: { display: 'inline-flex' } }, this._showCalendar && (index.h("nav", { class: "calendar-container", "aria-label": "Pick a Date" }, this.renderCalendarHeader(), this.renderCalendarBody())))));
    }
    get element() { return index.getElement(this); }
};
...
const ModusNumberInput = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.valueChange = index.createEvent(this, "valueChange", 7);
        this.inputId = utils.generateElementId() + '_number-input';
...
const ModusSelect = class {
    constructor(hostRef) {
        ...
        this.selectId = utils.generateElementId() + '_select';
        this.classBySize = new Map([
            ['medium', 'medium'],
            ['large', 'large'],
        ]);
    ...
    renderLabel() {
        return this.label || this.required ? (index.h("div", { class: "label-container" }, this.label ? index.h("label", { htmlFor: this.selectId }, this.label) : null, this.required ? index.h("span", { class: "required" }, "*") : null)) : null;
    }
    renderOptions() {
        var _a;
        return (_a = this.options) === null || _a === void 0 ? void 0 : _a.map((option) => {
            ...
            return (index.h("option", { value: optionId, key: optionId, selected: option[this.optionsDisplayProp] === this.internalValue }, option[this.optionsDisplayProp]));
        });
    }
    render() {
        var _a;
        const selectClass = `${this.classBySize.get(this.size)} ${this.errorText ? 'error' : this.validText ? 'valid' : this.disabled ? 'disabled' : ''}`;
        return (index.h("div", { key: 'ab38018e065d411d799c8c79d517ed0342a5fae8', class: this.disabled ? 'disabled' : undefined }, this.renderLabel(), index.h("span", { key: 'ad4acad2bfd52ac2ae4e9408d70d9a8e8a92d121', class: "input-container" }, index.h("select", { key: 'e9c56542b567e6a638c00854ac8b7275a56b2256', part: "input", ref: (el) => (this.selectInput = el), disabled: this.disabled, id: this.selectId, class: selectClass, "aria-label": this.ariaLabel || undefined, onBlur: (e) => this.inputBlur.emit(e), onChange: (event) => {
                this.handleSelectChange(event);
            }, "aria-invalid": !!this.errorText, "aria-required": (_a = this.required) === null || _a === void 0 ? void 0 : _a.toString() }, index.h("option", { key: '0ae21d39e25fbe3cadc84a25705744a46a6b9a85', value: "", disabled: true, selected: true }, this.placeholder), this.renderOptions()), this.renderSubText())));
    }
    static get watchers() { return {
        "value": ["handleValueChange"]
    }; }
...
const ModusTableCellEditor = class {
    ...
    renderNumberInput() {
        function handleArrowKeys(e, callback) {
            ...
            if (code === modusTable_constants.KEYBOARD_UP || code === modusTable_constants.KEYBOARD_DOWN) {
                e.stopPropagation();
            }
            else
                callback(e);
        }
        return (index.h("modus-number-input", Object.assign({}, this.getDefaultProps('Number input'), { value: this.value, textAlign: "right", size: "large", onBlur: this.handleBlur, onValueChange: (e) => (this.editedValue = e.detail), onKeyDown: (e) => handleArrowKeys(e, this.handleKeyDown) })));
    }
    renderTextInput() {
        return (index.h("modus-text-input", Object.assign({}, this.getDefaultProps('Text input'), { value: this.value, onValueChange: (e) => {
    ...
    renderSelectInput() {
        ...
        function handleEnter(e, callback) {
            const code = e.key.toLowerCase();
            if (code === modusTable_constants.KEYBOARD_ENTER) {
                e.stopPropagation();
            }
            else
                callback(e);
        }
        return (index.h("div", null, index.h("modus-select", Object.assign({}, this.getDefaultProps('Select input'), { value: selectedOption, "options-display-prop": optionsDisplayProp, size: "large", options: options, placeholder: placeholder, onInputBlur: this.handleBlur, onKeyDown: (e) => handleEnter(e, this.handleKeyDown), onValueChange: (e) => {
    ...
    renderDateInput() {
        ...
        return (index.h("modus-date-picker", { onBlur: this.handleBlur, position: "auto", onClick: (e) => e.stopPropagation(), class: "date-picker-container" }, index.h("modus-date-input", Object.assign({}, this.getDefaultProps('Date input'), { format: format, size: "large", "show-calendar-icon": "true", value: this.value, onValueChange: (e) => {
    ...
    renderEditor() {
        switch (this.type) {
            case modusTable_constants.CELL_EDIT_TYPE_SELECT:
                return this.renderSelectInput();
            case modusTable_constants.CELL_EDIT_TYPE_AUTOCOMPLETE:
                return this.renderAutocompleteInput();
            case modusTable_constants.CELL_EDIT_TYPE_DATE:
                return this.renderDateInput();
            case modusTable_constants.CELL_EDIT_TYPE_INT:
                return this.renderNumberInput();
            case modusTable_constants.CELL_EDIT_TYPE_TEXT:
            default:
                return this.renderTextInput();
        }
    }
    render() {
        return index.h(index.Host, { key: '3cb2c6b8d4f5c8257905ee7d32b4a5d2f1892170' }, this.renderEditor());
    }
};
ModusTableCellEditor.style = ModusTableCellEditorStyle0;

exports.flex_renderer = FlexRenderer;
exports.modus_autocomplete = ModusAutocomplete;
exports.modus_date_input = ModusDateInput;
exports.modus_date_picker = ModusDatePicker;
exports.modus_number_input = ModusNumberInput;
exports.modus_select = ModusSelect;
exports.modus_table_cell_editor = ModusTableCellEditor;
