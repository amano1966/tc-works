...
const ModusSideNavigationItem = class {
    constructor(hostRef) {
        ...
        this.sideNavItemClicked = index.createEvent(this, "sideNavItemClicked", 7);
        this.sideNavItemHeaderClicked = index.createEvent(this, "sideNavItemHeaderClicked", 7);
        this.sideNavItemFocus = index.createEvent(this, "sideNavItemFocus", 7);
        this._sideNavItemAdded = index.createEvent(this, "_sideNavItemAdded", 7);
        this._sideNavItemRemoved = index.createEvent(this, "_sideNavItemRemoved", 7);
        this.sideNavListItemClicked = index.createEvent(this, "sideNavListItemClicked", 7);
    ...
    setupPopper(expanded) {
        ...
        this.popperInstance = popper.createPopper(this.referenceRef, this.dropdownRef, {
    ...
    renderDropdown() {
        var _a, _b;
        return (index.h("div", { class: `dropdown-list ${this.dropdownVisible ? 'visible' : 'hidden'} list-border animate-list`, ref: (el) => (this.dropdownRef = el) }, index.h("modus-list", { slot: "dropdownList" }, (_b = (_a = this.isHeader) === null || _a === void 0 ? void 0 : _a.items) === null || _b === void 0 ? void 0 : _b.map((item) => (index.h("modus-list-item", { key: item.id, class: "list-item", borderless: true, onClick: () => this.handleListItemClick(item), onMouseDown: (e) => e.stopPropagation() }, index.h("span", { class: "dropdown-item" }, index.h(ModusIconMap.ModusIconMap, { icon: item === null || item === void 0 ? void 0 : item.icon, size: "24" }), index.h("span", { class: "menu-item-text" }, item === null || item === void 0 ? void 0 : item.label))))))));
    }
    render() {
        var _a, _b;
        const classes = {
        ...
        return (index.h(index.Host, { key: 'd4bdedb88c38428854b9accdc6d446ddf4794847' }, ((_a = this.isHeader) === null || _a === void 0 ? void 0 : _a.enabled) && this.renderDropdown(), index.h("modus-tooltip", { key: 'b69df05ede4b8851c12a46d69d80a06d5a5ae8ad', text: this.label, disabled: this.disabled, position: "right" }, index.h("li", { key: '6f2c8afa51dd8474e13f7a52c4e5f60a3f071a35', role: "treeitem", ref: (el) => (this.referenceRef = el), tabIndex: this.disabled ? -1 : 0, class: classes, onClick: () => this.handleClick(), onKeyDown: (e) => this.handleKeyDown(e), "aria-disabled": this.disabled ? 'true' : null, "aria-label": this.label, "aria-current": this.selected ? 'true' : null, onFocus: () => this.sideNavItemFocus.emit({ id: this.element.id }) }, index.h("div", { key: '6c3d9a52b1030e512b78b23f7de8b71fce54d585', class: "menu-icon" }, index.h("slot", { key: '34f8cc40110e7b9485d2fd8cea553e0b16ea2672', name: "menu-icon" }), this.menuIcon && index.h(ModusIconMap.ModusIconMap, { icon: this.menuIcon, "aria-label": this.label, size: "24" })), this.expanded && index.h("div", { class: "menu-text" }, this.label), index.h("div", { key: '43ab3253e1e596bc733f2461f0bad687ccd54414', class: `level-icon ${((_b = this.isHeader) === null || _b === void 0 ? void 0 : _b.enabled) && this.expanded ? (this.dropdownVisible ? 'icon-dropdownvisible' : 'icon-expanded') : 'icon-collapsed'}` }, this.showExpandIcon && index.h(ModusIconMap.ModusIconMap, { icon: "chevron_right", size: "16" }))))));
    }
...
exports.modus_side_navigation_item = ModusSideNavigationItem;
