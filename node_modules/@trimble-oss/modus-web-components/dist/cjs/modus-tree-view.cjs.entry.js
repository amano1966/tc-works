...
const modusContentTree_constants = require('./modus-content-tree.constants-12132ae9.js');
...
const ModusTreeView = class {
    constructor(hostRef) {
        ...
        this.itemActionClick = index.createEvent(this, "itemActionClick", 7);
    ...
    render() {
        return (index.h(index.Host, { key: '8f3612230fd3eabd0b06e0fff972defc8a77745b' }, index.h("ul", { key: '663ea4ab53a25618226649a61014c0b0385109a7', role: "tree", tabindex: this.disableTabbing ? 0 : null, onKeyDown: (e) => this.handleKeyDown(e) }, index.h("slot", { key: '1f30b5548cb1a2defa0faefe1f99da7b2dc59bb0', onSlotchange: () => this.handleTreeSlotChange() })), index.h(ModusContentTreeDragItem, { key: '56a14e7456ad2019ef4d8d21900181f6c654c7a4', draggingState: this.itemDragState }, index.h("div", { key: 'ab4f7d792b3420a835ae431adf28a6fd1c33dee2', class: "drag-indicator", tabIndex: -1 }))));
    }
