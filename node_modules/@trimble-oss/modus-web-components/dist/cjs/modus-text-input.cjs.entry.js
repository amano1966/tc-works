...
const IconVisibilityOff = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-visibility-off ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : 16, height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, fill: (_c = props.color) !== null && _c !== void 0 ? _c : 'currentColor', onClick: props.onClick ? () => props.onClick() : null, viewBox: "0 0 24 24" },
...
const ModusTextInput = class {
    constructor(hostRef) {
        ...
        this.inputId = utils.generateElementId() + '_text_input';
