...
const iconCheck = require('./icon-check-a22357b3.js');
...
const IconRemove = (props) => {
    var _a, _b, _c;
    return (index.h("svg", { class: `icon-remove ${props.pressed ? 'pressed' : ''}`, height: (_a = props.size) !== null && _a !== void 0 ? _a : 16, width: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none" },
...
const ModusChip = class {
    ...
    `;
        ...
        return (index.h("button", { key: '6cbd7f607b28fc33022c14e40f6b8a3683660e6b', "aria-disabled": this.disabled ? 'true' : undefined, "aria-label": this.ariaLabel || undefined, id: this.chipId || undefined, class: chipClass, part: "chipButton", onClick: this.disabled ? null : (event) => this.onChipClick(event), tabIndex: 0, style: this.advancedChip ? { 'border-radius': '8px' } : {}, type: "button" }, this.imageUrl ? (index.h("img", { src: this.imageUrl, alt: "" })) : this.showCheckmark ? (index.h(iconCheck.IconCheck, { size: '16' })) : null, index.h("span", Object.assign({ key: '262d81e42652bec6f273f37f8c238804171b727c' }, style), this.value), this.advancedChip && index.h(ModusIconMap.ModusIconMap, { icon: "caret_down", size: '16' }), this.showClose ? (this.advancedChip ? (index.h(IconClose.IconClose, { onClick: this.disabled ? null : (event) => this.onCloseClick(event), size: '16' })) : (index.h(IconRemove, { onClick: this.disabled ? null : (event) => this.onCloseClick(event), size: '16' }))) : null));
    }
};
ModusChip.style = ModusChipStyle0;

const modusSpinnerCss = "@keyframes spin{0%{transform:rotate(0deg)}100%{transform:rotate(360deg)}}div.spinner{animation:spin 0.75s linear infinite;border:0.25em solid #0063a3;border-radius:50%;border-right-color:transparent;display:inline-flex;font-family:\"Open Sans\", -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji\";forced-color-adjust:none}";
...
const ModusSpinner = class {
    ...
    render() {
        const borderColor = this.variants.has(this.color)
            ...
            : this.color;
        return (index.h("div", { key: '70cb7810d3944b16c2e72ebdbd4c96360322b114', "aria-busy": "true", class: "spinner", style: {
...
ModusSpinner.style = ModusSpinnerStyle0;
