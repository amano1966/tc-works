...
const ModusSideNavigationTree = ({ data, itemSelected, tabIndex }) => {
    ...
    return data === null || data === void 0 ? void 0 : data.map(({ id, disabled, selected, label, menuIcon, children, onSideNavItemClicked, options, isHeader }) => {
        ...
        return (index.h("modus-side-navigation-item", Object.assign({ id: id, disabled: disabled, selected: selected || itemSelected === id, label: label, menuIcon: menuIcon, isHeader: isHeader, onSideNavItemClicked: (e) => onSideNavItemClicked && onSideNavItemClicked(e) }, defaults, { tabIndex: tabIndex }, props)));
    });
};
...
ModusSideNavigation.style = ModusSideNavigationStyle0;
