...
const ModusAccordionItem = class {
    ...
    renderIcon() {
        ...
        return (index.h("span", { class: "icon" }, index.h(ModusIconMap.ModusIconMap, { icon: this.icon, size: iconSize })));
    }
    render() {
        ...
        return (index.h("div", { key: 'ffbaddcfb8629176926443aa42edefb983658f1d', "aria-disabled": this.disabled ? 'true' : undefined, "aria-expanded": this.expanded ? 'true' : undefined, class: "accordion-item" }, index.h("div", { key: 'eeeea7eb6ddb35825b3c2630b615da40dc7fb030', class: headerClass, role: "button", "aria-expanded": this.expanded ? 'true' : 'false', "aria-controls": this.expandedContentId, onClick: () => this.handleHeaderClick(), onKeyDown: (event) => this.handleKeydown(event), tabIndex: this.disabled ? -1 : 0 }, this.icon ? this.renderIcon() : null, index.h("div", { key: '710d83ef1093fa97062c9ab33d95fd1e9b2d72c3', class: "label-container" }, index.h("span", { key: '744f788063a01f913274eb743242476048362030', class: "title" }, this.headerText), this.supportingLabel && index.h("span", { class: "supporting-label" }, this.supportingLabel)), index.h("div", { class: `chevron-container ${this.expanded ? 'reverse' : ''} `, ref: (el) => (this.chevronContainerRef = el) }, this.expandButtonType == 'circleArrow' ? (index.h(ModusIconMap.IconExpandMoreCircle, { size: expandIconSize })) : (index.h(ModusIconMap.IconExpandMore, { size: expandIconSize })))), index.h("div", { key: 'b3c47cb05778da5d72005d01d25ada4844248fa4', id: this.expandedContentId, class: bodyClass, ref: (el) => (this.accordionBodyRef = el) }, index.h("div", { key: 'ff7a12e88cb25c040b6206f98957b1b3242d3ed7', class: "body-content" }, index.h("slot", { key: '194aaf3f2480c679030f4de8d102d423897c14e6' })))));
    }
};
