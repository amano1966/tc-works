...
const ModusProgressBar = class {
    ...
    render() {
     ...
     `;
        ...
        return (index.h(index.Host, { key: '598b24ac61bf998feea59b9188bd4ea9c2fb9b29', "aria-label": this.ariaLabel, "aria-valuemax": this.mode === 'determinate' ? this.maxValue : null, "aria-valuemin": this.mode === 'determinate' ? this.minValue : null, "aria-valuenow": this.mode === 'determinate' ? this.value : null, role: "progressbar" }, index.h("div", { key: '0c881a3a711ee478d624c11834c858aeef646348', class: progressBarClass, style: this.getProgressBarStyle() }, index.h("div", { key: 'd6f1f979aa8bdb2ddb63188b1052655e7392c072', class: progressClass, style: this.getProgressStyle(percentage) }, this.size === 'default' && this.mode === 'determinate' && this.text))));
    }
};
ModusProgressBar.style = ModusProgressBarStyle0;
