...
const ModusBreadcrumb$1 = /*@__PURE__*/ proxyCustomElement(class ModusBreadcrumb extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return ModusBreadcrumbStyle0; }
}, [1, "modus-breadcrumb", {
        "ariaLabel": [1, "aria-label"],
        "crumbs": [16],
        "underlineLinks": [4, "underline-links"]
    }]);
