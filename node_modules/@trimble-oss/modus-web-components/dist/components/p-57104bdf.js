...
import { I as IconSearch, d as defineCustomElement$1 } from './p-ba98e9ed.js';
import { g as generateElementId } from './p-ce031ddc.js';
import { b as IconCheck } from './p-cf76d4e3.js';
import { I as IconClose } from './p-58bb9767.js';
import { d as defineCustomElement$3 } from './p-712cbdfb.js';
...
const ModusAutocomplete = /*@__PURE__*/ proxyCustomElement(class ModusAutocomplete extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return ModusAutocompleteStyle0; }
        ...
        "required": [4],
        "showNoResultsFoundMessage": [1028, "show-no-results-found-message"],
        "size": [1],
        "value": [1025],
        "selectedChips": [32],
        "selectedOption": [32],
...
function defineCustomElement() {
    ...
    const components = ["modus-autocomplete", "modus-chip", "modus-spinner", "modus-text-input"];
