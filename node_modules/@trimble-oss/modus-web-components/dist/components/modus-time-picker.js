...
const ModusTimePicker$1 = /*@__PURE__*/ proxyCustomElement(class ModusTimePicker extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    render() {
        return (h("div", { key: '71008b0018f20b54be6f03bec3e44fdd58b53ca3', class: { 'modus-time-picker': true, disabled: this.disabled } }, h("div", { key: 'ac10adff6569fa39cb15d744a9b63f67a16864b3', class: "time-input-wrapper" }, this.label || this.required ? (h("div", { class: 'label-container' }, this.label ? h("label", { htmlFor: "time-input" }, this.label) : null, this.required ? h("span", { class: "required" }, "*") : null, this.helperText ? h("label", { class: "sub-text helper" }, this.helperText) : null)) : null, h("div", { key: 'f3efd7529da17c4599848ab9981fcc29927562fb', class: `input-container ${this.errorText ? 'error' : this.validText ? 'valid' : ''} ${this.classBySize.get(this.size)}` }, this.renderTimeInput()), this.renderSubText()), h("div", { key: '92c585ff751568f97f6eb5ca48d19e83bb2fb61c', class: "time-zone-wrapper" }, h("slot", { key: 'd8ab08e4a10507df62951f4cb06692523105583f', name: "timeZone" }))));
    }
    ...
    static get style() { return ModusTimePickerStyle0; }
}, [1, "modus-time-picker", {
        "ampm": [4],
