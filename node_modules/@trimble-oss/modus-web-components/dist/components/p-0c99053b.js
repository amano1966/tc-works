...
const modusActionBarCss = ".modus-action-bar{align-items:center;display:flex;gap:0}.modus-action-bar .overflow-menu{display:none;position:absolute;z-index:1}.modus-action-bar .overflow-menu.show{display:block}";
const ModusActionBarStyle0 = modusActionBarCss;

const ModusActionBar = /*@__PURE__*/ proxyCustomElement(class ModusActionBar extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
