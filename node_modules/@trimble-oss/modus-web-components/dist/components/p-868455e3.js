...
const ModusDropdown = /*@__PURE__*/ proxyCustomElement(class ModusDropdown extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return ModusDropdownStyle0; }
}, [1, "modus-dropdown", {
        "animateList": [4, "animate-list"],
        "ariaLabel": [1, "aria-label"],
        "customPlacement": [16],
        "disabled": [4],
        "toggleDropdown": [4, "toggle-dropdown"],
        "placement": [1],
        "showDropdownListBorder": [4, "show-dropdown-list-border"],
        "borderRadius": [1, "border-radius"],
        "toggleElementId": [1, "toggle-element-id"],
        "disableCloseOnSelect": [4, "disable-close-on-select"],
        "visible": [32]
    }, [[4, "click", "documentClickHandler"], [4, "keydown", "documentKeyDownHandler"]], {
        "disabled": ["onDisabledChange"]
    }]);
