...
const ModusButton = /*@__PURE__*/ proxyCustomElement(class ModusButton extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    render() {
        ...
        return (h("button", { key: 'bde558a95305b44f59be0e4b850d1392f31d762d', "aria-disabled": this.ariaDisabled ? this.ariaDisabled : this.disabled ? 'true' : undefined, "aria-label": this.isCriticalAction()
    ...
    static get style() { return ModusButtonStyle0; }
        ...
        "type": [1],
        "criticalAction": [4, "critical-action"],
        "isActive": [32],
        "pressed": [32],
        "progressState": [32],
        "keyProgressState": [32],
