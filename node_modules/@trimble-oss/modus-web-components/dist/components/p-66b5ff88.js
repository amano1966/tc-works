...
import { d as defineCustomElement$3 } from './p-dca65392.js';
import { d as defineCustomElement$2 } from './p-34f769d6.js';
...
const ModusSideNavigationItem = /*@__PURE__*/ proxyCustomElement(class ModusSideNavigationItem extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    findParentReference(element) {
        ...
        while (currentNode) {
            if (currentNode instanceof H && currentNode.matches('nav')) {
                return currentNode;
            }
    ...
    static get style() { return ModusSideNavigationItemStyle0; }
}, [1, "modus-side-navigation-item", {
        "disabled": [4],
        "disableSelection": [1540, "disable-selection"],
        "expanded": [1540],
        "label": [1537],
        "menuIcon": [1, "menu-icon"],
        "selected": [1540],
        "showExpandIcon": [1540, "show-expand-icon"],
        "isHeader": [16],
        "dropdownVisible": [32],
        "focusItem": [64]
    }, undefined, {
...
function defineCustomElement() {
    ...
    const components = ["modus-side-navigation-item", "modus-list", "modus-list-item", "modus-tooltip"];
    components.forEach(tagName => { switch (tagName) {
        case "modus-side-navigation-item":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ModusSideNavigationItem);
            }
            break;
        case "modus-list":
            if (!customElements.get(tagName)) {
...
export { ModusSideNavigationItem as M, defineCustomElement as d };
