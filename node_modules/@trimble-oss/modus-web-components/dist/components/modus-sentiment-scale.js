...
const IconSmileySatisfiedOutline = (props) => {
    var _a, _b, _c;
    return (h("svg", { class: `icon-smiley-satistied-outline ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none" },
...
const IconSmileySatisfied = (props) => {
    var _a, _b, _c;
    return (h("svg", { class: `icon-smiley-satistied ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none" },
...
const IconSmileySomewhatSatisfiedOutline = (props) => {
    var _a, _b, _c;
    return (h("svg", { class: `icon-smiley-somewhat-satistied-outline ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none" },
...
const IconSmileySomewhatSatisfied = (props) => {
    var _a, _b, _c;
    return (h("svg", { class: `icon-smiley-somewhat-satistied ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none" },
...
const IconSmileyNeutralOutline = (props) => {
    var _a, _b, _c;
    return (h("svg", { class: `icon-smiley-neutral-outline ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none" },
...
const IconSmileyNeutral = (props) => {
    var _a, _b, _c;
    return (h("svg", { class: `icon-smiley-neutral ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none" },
...
const IconSmileySomewhatDissatisfiedOutline = (props) => {
    var _a, _b, _c;
    return (h("svg", { class: `icon-smiley-somewhat-dissatistied-outline ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none" },
...
const IconSmileySomewhatDissatisfied = (props) => {
    var _a, _b, _c;
    return (h("svg", { class: `icon-smiley-somewhat-dissatistied ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none" },
...
const IconSmileyDissatisfiedOutline = (props) => {
    var _a, _b, _c;
    return (h("svg", { class: `icon-smiley-dissatistied-outline ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none" },
...
const IconSmileyDissatisfied = (props) => {
    var _a, _b, _c;
    return (h("svg", { class: `icon-smiley-dissatistied ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none" },
...
const IconThumbsUpOutlined = (props) => {
    var _a, _b, _c;
    return (h("svg", { class: `icon-thumbs-up-outlined ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '14', height: (_b = props.size) !== null && _b !== void 0 ? _b : 14, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none" },
...
const IconThumbsUp = (props) => {
    var _a, _b, _c;
    return (h("svg", { class: `icon-thumbs-up ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none" },
...
const IconThumbsDownOutlined = (props) => {
    var _a, _b, _c;
    return (h("svg", { class: `icon-thumbs-down-outlined ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '14', height: (_b = props.size) !== null && _b !== void 0 ? _b : 14, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none" },
...
const IconThumbsDown = (props) => {
    var _a, _b, _c;
    return (h("svg", { class: `icon-thumbs-down ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '16', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: "none" },
...
const ModusSentimentScale$1 = /*@__PURE__*/ proxyCustomElement(class ModusSentimentScale extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    render() {
        ...
        return (h$1("div", { key: 'e968794f6f3dfec966d95b4c38bee83cfc289424', class: "sentiment-scale-container", "aria-disabled": this.disabled ? 'true' : undefined, "aria-label": this.ariaLabel || undefined, role: "group" }, iconsMap &&
            Array.from(iconsMap).map(([key, value]) => {
                ...
                return (h$1("div", { "aria-label": value, "aria-selected": isIconSelected ? isIconSelected.toString() : undefined, role: "button", tabIndex: tabIndexValue, class: containerClass, onClick: () => this.handleSentimentClick(key), onKeyDown: (event) => this.handleKeyDown(event, key) }, h$1(SentimentIconMap, { icon: iconName, size: `${this.type === THUMB_SENTIMENT_TYPE ? '32' : '24'}` })));
            })));
    }
