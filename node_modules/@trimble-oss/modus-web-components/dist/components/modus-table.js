...
import { C as COLUMN_DEF_ROW_SELECTION_ID, a as COLUMN_DEF_ROW_SELECTION_CSS, b as COLUMN_DEF_DATATYPE_KEY, c as COLUMN_DEF_DATATYPE_INTEGER, d as COLUMN_DEF_SHOWTOTAL, K as KEYBOARD_RIGHT, e as KEYBOARD_LEFT, f as KEYBOARD_ENTER, g as KEYBOARD_ESCAPE, h as KEYBOARD_TAB, H as HTML_ATTR_DATA_ACCESSOR_KEY, i as COLUMN_DEF_SUB_ROWS_KEY, j as KEYBOARD_SPACE, P as PAGINATION_DEFAULT_SIZES, E as EXPANDED_STATE_KEY, S as SORTING_STATE_KEY, k as PAGINATION_STATE_KEY, l as COLUMN_SIZING_STATE_KEY, m as COLUMN_VISIBILITY_STATE_KEY, n as COLUMN_ORDER_STATE_KEY, R as ROW_SELECTION_STATE_KEY, o as COLUMN_SIZING_INFO_STATE_KEY } from './p-5d1d55be.js';
import { h } from './p-5f965237.js';
import { M as ModusIconMap } from './p-cf76d4e3.js';
import { N as NavigateTableCells } from './p-3af926db.js';
import { c as createGuid } from './p-ce031ddc.js';
import { d as defineCustomElement$q } from './p-378ceba8.js';
import { d as defineCustomElement$p } from './p-57104bdf.js';
import { d as defineCustomElement$o } from './p-5d4f663e.js';
import { d as defineCustomElement$n } from './p-56367692.js';
import { d as defineCustomElement$m } from './p-a67f7d10.js';
import { d as defineCustomElement$l } from './p-712cbdfb.js';
import { d as defineCustomElement$k } from './p-854b47fa.js';
import { d as defineCustomElement$j } from './p-f5c6b288.js';
import { d as defineCustomElement$i } from './p-dca65392.js';
import { d as defineCustomElement$h } from './p-34f769d6.js';
import { d as defineCustomElement$g } from './p-92734348.js';
import { d as defineCustomElement$f } from './p-229caa9e.js';
import { d as defineCustomElement$e } from './p-9158ea44.js';
import { d as defineCustomElement$d } from './p-1b7ef7fc.js';
import { d as defineCustomElement$c } from './p-25e7c862.js';
import { d as defineCustomElement$b } from './p-6abe744a.js';
import { d as defineCustomElement$a } from './p-97d71c36.js';
import { d as defineCustomElement$9 } from './p-affe4060.js';
import { d as defineCustomElement$8 } from './p-72a4303e.js';
import { d as defineCustomElement$7 } from './p-6905d804.js';
import { d as defineCustomElement$6 } from './p-a25312bd.js';
import { d as defineCustomElement$5 } from './p-561ee2f3.js';
import { d as defineCustomElement$4 } from './p-8f144f06.js';
import { d as defineCustomElement$3 } from './p-ba98e9ed.js';
import { d as defineCustomElement$2 } from './p-03a9687b.js';

const IconArrowDown = (props) => {
    var _a, _b, _c;
    return (h("svg", { class: `icon-arrow-down ${props.pressed ? 'pressed' : ''}`, fill: (_a = props.color) !== null && _a !== void 0 ? _a : 'currentColor', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick, viewBox: "0 0 24 24", width: (_c = props.size) !== null && _c !== void 0 ? _c : 16 },
...
const IconArrowUp = (props) => {
    var _a, _b, _c;
    return (h("svg", { class: `icon-arrow-up ${props.pressed ? 'pressed' : ''}`, "data-test-id": "iconArrowUp", fill: (_a = props.color) !== null && _a !== void 0 ? _a : 'currentColor', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick, viewBox: "0 0 24 24", width: (_c = props.size) !== null && _c !== void 0 ? _c : 16 },
...
const ModusTablePagination = ({ context: { tableInstance: table, pageSizeList, data, manualPaginationOptions }, }) => {
    ...
    return (h("div", { class: "pagination-container" },
        h("div", { class: "items-per-page" },
            h("span", null, translate('pageView')),
            h("modus-select", { ariaLabel: "Select page size", "options-display-prop": "display", options: optionsList, placeholder: translate('pleaseSelect'), onValueChange: handleChange, value: selectedPageSize })),
        h("div", { class: "pagination-and-count" },
            h("div", { class: "total-count" },
                h("span", null, translate('showingResult')),
...
const ModusTableHeader = ({ context, onDragStart, getColumnResizing, setColumnResizing, }) => {
    ...
    return (h("thead", { class: tableHeadClass }, headerGroups === null || headerGroups === void 0 ? void 0 : headerGroups.map((headerGroup, index) => {
        ...
        return (h("tr", { key: headerGroup.id },
            ...
            rowActions.length > 0 && (h("th", { class: "sticky-right", style: { width: `${rowActionsConfig.width}px` } }, rowActionsConfig.header))));
    })));
};
...
const ModusTableCellCheckbox = ({ multipleRowSelection, row, isChecked, checkboxSize, updateRow, disableRow, }) => {
    ...
    return (h("td", { class: 'row-checkbox sticky-left ' + (checkboxSize !== null && checkboxSize !== void 0 ? checkboxSize : ''), tabIndex: 0, ref: (el) => (cellEl = el), onFocus: () => checkboxInput === null || checkboxInput === void 0 ? void 0 : checkboxInput.focusCheckbox(), onKeyDown: (e) => handleKeyDown(e) },
        h("modus-checkbox", { ariaLabel: "Select row", ref: (el) => (checkboxInput = el), checked: isChecked, indeterminate: multipleRowSelection && row.getIsSomeSelected(), size: checkboxSize, disabled: disableRow, onKeyDown: (e) => handleCheckboxKeyDown(e) })));
};
...
const ModusTable$1 = /*@__PURE__*/ proxyCustomElement(class ModusTable extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    renderToolBar() {
        return (this.toolbar &&
            this.toolbarOptions && (h$1("modus-table-toolbar", { context: this._context }, h$1("div", { slot: "group-left" }, h$1("slot", { name: "groupLeft" })), h$1("div", { slot: "group-right" }, h$1("slot", { name: "groupRight" })))));
    }
    renderMain() {
        ...
        return (h$1(Fragment, null, h$1("div", { class: tableContainerClass, style: { maxHeight: this.maxHeight } }, this.renderTable(), !this.fullWidth && (h$1("modus-table-filler-column", { container: this.element, "summary-row": this.summaryRow, "cell-borderless": cellBorderless }))), h$1("slot", { name: "customFooter" })));
    }
    renderTable() {
        var _a, _b, _c;
    ...
    `;
        const tableStyle = this.fullWidth
            ...
            : totalSize > 0
                ...
                : { tableLayout: 'fixed' };
        return (h$1("table", { "data-test-id": "main-table", class: tableMainClass, style: tableStyle }, this.renderTableHeader(), this.renderTableBody(), this.renderTableFooter()));
    }
    renderTableHeader() {
        ...
        return (h$1(ModusTableHeader, { context: this._context, setColumnResizing: setColumnResizing, getColumnResizing: getColumnResizing, onDragStart: onDragStart }));
    }
    renderTableBody() {
        return h$1(ModusTableBody, { context: this._context });
    }
    renderTableFooter() {
        return this.summaryRow ? h$1(ModusTableFooter, { context: this._context }) : null;
    }
    renderPagination() {
        return this.pagination && h$1(ModusTablePagination, { context: this._context });
    }
    render() {
        var _a;
        return (h$1(Host, { key: 'b0a13e34ef5f00b38444bca8bc5193c3032a96f8', id: this._id }, h$1("div", { key: '41fb8cc396890e63431d3d851a84181c338977f9', style: { maxWidth: this.maxWidth } }, this.renderToolBar(), this.renderMain(), this.renderPagination(), h$1(ModusTableColumnDragItem, { key: '6e28094e11b7446b82b83d3ecd0a92c45b5d7767', draggingState: this.itemDragState }), h$1(ModusTableColumnDropIndicator, { key: '4b2b34a68f4527244eefc436fdaac4631635c7b3', position: (_a = this.itemDragState) === null || _a === void 0 ? void 0 : _a.dropIndicator }), h$1("modus-table-row-actions-menu", { key: '8440d7ac598601cf22f2420220c4058705754cc1', context: this._context }))));
    }
    ...
    static get style() { return ModusTableStyle0; }
}, [1, "modus-table", {
        "columns": [1040],
...
function defineCustomElement$1() {
    ...
    const components = ["modus-table", "flex-renderer", "modus-autocomplete", "modus-badge", "modus-button", "modus-checkbox", "modus-chip", "modus-date-input", "modus-date-picker", "modus-list", "modus-list-item", "modus-number-input", "modus-pagination", "modus-select", "modus-spinner", "modus-table-cell-editor", "modus-table-cell-main", "modus-table-columns-visibility", "modus-table-dropdown-menu", "modus-table-filler-column", "modus-table-row-actions", "modus-table-row-actions-cell", "modus-table-row-actions-menu", "modus-table-toolbar", "modus-text-input", "modus-tooltip"];
