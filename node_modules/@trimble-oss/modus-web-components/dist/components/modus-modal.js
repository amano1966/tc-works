...
import { h, F as Fragment } from './p-5f965237.js';
import { e as IconCollapse, f as IconExpand } from './p-cf76d4e3.js';
...
const ModusModal$1 = /*@__PURE__*/ proxyCustomElement(class ModusModal extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    renderModal() {
        return (h$1("div", { class: "content", ref: (el) => (this.modalContentRef = el), onMouseDown: () => this.handleModalContentMouseDown() }, h$1(FocusWrap, { id: "startTrap", ref: (el) => (this.startTrapRef = el), onFocus: () => { var _a; return (_a = this.focusWrapping) === null || _a === void 0 ? void 0 : _a.onStartWrapFocus(); } }), this.renderModalHeader(), h$1("div", { class: "body", ref: (el) => (this.modalBodyRef = el) }, h$1("slot", null)), this.renderModalFooter(), h$1(FocusWrap, { id: "endTrap", onFocus: () => { var _a; return (_a = this.focusWrapping) === null || _a === void 0 ? void 0 : _a.onEndWrapFocus(); } })));
    }
    renderModalHeader() {
        return (h$1("header", { class: { scrollable: this.isContentScrollable } }, this.headerText, h$1("div", { class: "header-buttons" }, this.showFullscreenToggle && (h$1("div", { role: "button", tabindex: 0, "aria-label": this.fullscreen ? 'Collapse' : 'Expand', onClick: () => this.toggleFullscreen(), onKeyDown: (event) => this.handleEnterKeydown(event, () => this.toggleFullscreen()) }, this.fullscreen ? h$1(IconCollapse, { size: "24" }) : h$1(IconExpand, { size: "24" }))), h$1("div", { role: "button", tabindex: 0, "aria-label": "Close", onClick: () => this.close(), onKeyDown: (event) => this.handleEnterKeydown(event, () => this.close()) }, h$1(IconClose, { size: "24" })))));
    }
    renderModalFooter() {
        return (h$1(Fragment, null, h$1("footer", { class: {
                'has-buttons': Boolean(this.primaryButtonText || this.secondaryButtonText),
                scrollable: this.isContentScrollable,
            } }, this.secondaryButtonText && (h$1("modus-button", { disabled: this.secondaryButtonDisabled, "button-style": "outline", color: "secondary", ariaLabel: this.secondaryButtonAriaLabel, onButtonClick: () => this.handleSecondaryClick() }, this.secondaryButtonText)), this.primaryButtonText && (h$1("modus-button", { disabled: this.primaryButtonDisabled, color: "primary", ariaLabel: this.primaryButtonAriaLabel, onButtonClick: () => this.handlePrimaryClick() }, this.primaryButtonText)), h$1("slot", { name: "footerContent" }))));
    }
    render() {
        return (h$1("div", { key: '763cdb0f034096b6ba74cf9041db50350fc50d21', "aria-hidden": this.visible ? undefined : 'true', "aria-label": this.visible ? this.ariaLabel || undefined : undefined, "aria-modal": this.visible ? 'true' : undefined, class: `modus-modal ${this.fullscreen ? 'fullscreen' : ''} overlay ${this.visible ? 'visible' : 'hidden'}`, onClick: (event) => this.handleOverlayClick(event), role: this.visible ? 'dialog' : undefined, style: { zIndex: this.zIndex } }, this.renderModal()));
    }
    get el() { return this; }
    static get style() { return ModusModalStyle0; }
}, [1, "modus-modal", {
        ...
        "zIndex": [1, "z-index"],
        "backdrop": [1],
        "showFullscreenToggle": [4, "show-fullscreen-toggle"],
        "fullscreen": [1028],
        "isContentScrollable": [32],
        "visible": [32],
        "close": [64],
        "open": [64]
