...
const IconSearch = (props) => {
    var _a, _b, _c;
    return (h("svg", { class: `icon-search ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : '14', height: (_b = props.size) !== null && _b !== void 0 ? _b : 14, onClick: props.onClick ? (event) => props.onClick(event) : null, viewBox: "0 0 24 24", fill: (_c = props.color) !== null && _c !== void 0 ? _c : 'currentColor' },
        h("path", { d: "M15.5 14H14.71L14.43 13.73C15.41 12.59 16 11.11 16 9.5C16 5.91 13.09 3 9.5 3C5.91 3 3 5.91 3 9.5C3 13.09 5.91 16 9.5 16C11.11 16 12.59 15.41 13.73 14.43L14 14.71V15.5L19 20.49L20.49 19L15.5 14ZM9.5 14C7.01 14 5 11.99 5 9.5C5 7.01 7.01 5 9.5 5C11.99 5 14 7.01 14 9.5C14 11.99 11.99 14 9.5 14Z" })));
};

// eslint-disable-next-line
const IconVisibilityOff = (props) => {
    var _a, _b, _c;
    return (h("svg", { class: `icon-visibility-off ${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : 16, height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, fill: (_c = props.color) !== null && _c !== void 0 ? _c : 'currentColor', onClick: props.onClick ? () => props.onClick() : null, viewBox: "0 0 24 24" },
...
const ModusTextInput = /*@__PURE__*/ proxyCustomElement(class ModusTextInput extends H {
    ...
    render() {
        ...
        return (h$1("div", { class: buildContainerClassNames() }, this.label || this.required ? (h$1("div", { class: 'label-container' }, this.label ? h$1("label", { htmlFor: this.inputId }, this.label) : null, this.required ? h$1("span", { class: "required" }, "*") : null, this.helperText ? h$1("label", { class: "sub-text helper" }, this.helperText) : null)) : null, h$1("div", { class: `input-container ${this.errorText ? 'error' : this.validText ? 'valid' : ''} ${this.classBySize.get(this.size)}`, onClick: () => this.textInput.focus(), part: "input-container" }, this.includeSearchIcon ? h$1(IconSearch, { size: iconSize }) : null, h$1("input", { id: this.inputId, name: this.name, "aria-invalid": !!this.errorText, "aria-label": this.ariaLabel || undefined, "aria-required": (_b = this.required) === null || _b === void 0 ? void 0 : _b.toString(), autocapitalize: this.autocapitalize, autocomplete: this.autocomplete, autocorrect: this.autocorrect, class: buildTextInputClassNames(), disabled: this.disabled, enterkeyhint: this.enterkeyhint, inputmode: this.inputmode, maxlength: this.maxLength, minlength: this.minLength, onInput: (event) => this.handleOnInput(event), pattern: this.pattern, placeholder: this.placeholder, readonly: this.readOnly, ref: (el) => (this.textInput = el), spellcheck: this.spellcheck, tabIndex: 0, type: this.type, value: this.value, autofocus: this.autoFocusInput }), showPasswordToggle && (h$1("div", { class: "icons toggle-password", tabIndex: 0, onKeyDown: (event) => this.handleTogglePasswordKeyDown(event), onClick: () => this.handleTogglePassword(), role: "button", "aria-label": "Show password as plain text. Warning: this will display your password on the screen.", ref: (el) => (this.buttonTogglePassword = el) }, this.passwordVisible ? h$1(IconVisibilityOn, { size: iconSize }) : h$1(IconVisibilityOff, { size: iconSize }))), showClearIcon && (h$1("span", { class: "icons clear", tabIndex: 0, onKeyDown: (event) => this.handleClearKeyDown(event), onClick: () => this.handleClear(), role: "button", "aria-label": "Clear entry" }, h$1(IconClose, { size: iconSize })))), this.errorText ? (h$1("label", { class: "sub-text error" }, this.includeErrorIcon ? h$1(IconError, { size: iconSize }) : null, this.errorText)) : this.validText ? (h$1("label", { class: "sub-text valid" }, this.validText)) : null));
    }
    static get formAssociated() { return true; }
    static get style() { return ModusTextInputStyle0; }
}, [65, "modus-text-input", {
        ...
        "includeErrorIcon": [4, "include-error-icon"],
...
export { IconSearch as I, ModusTextInput as M, defineCustomElement as d };
