...
const ModusTextareaInput$1 = /*@__PURE__*/ proxyCustomElement(class ModusTextareaInput extends H {
    ...
    static get style() { return ModusTextareaInputStyle0; }
}, [1, "modus-textarea-input", {
...
function defineCustomElement$1() {
    ...
    const components = ["modus-textarea-input"];
    components.forEach(tagName => { switch (tagName) {
        case "modus-textarea-input":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ModusTextareaInput$1);
            }
            break;
    } });
}

const ModusTextareaInput = ModusTextareaInput$1;
const defineCustomElement = defineCustomElement$1;

export { ModusTextareaInput, defineCustomElement };
