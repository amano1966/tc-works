...
import { d as defineCustomElement$5 } from './p-5d4f663e.js';
import { d as defineCustomElement$4 } from './p-a67f7d10.js';
import { d as defineCustomElement$3 } from './p-868455e3.js';
...
const IconSortAZ = (props) => {
    var _a, _b, _c;
    return (h("svg", { "data-test-id": "iconSortAZ", class: `${props.pressed ? 'pressed' : ''}`, fill: (_a = props.color) !== null && _a !== void 0 ? _a : 'currentColor', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, onClick: props.onClick, viewBox: "0 0 32 32", width: (_c = props.size) !== null && _c !== void 0 ? _c : 16 },
...
const IconSortZA = (props) => {
    var _a, _b, _c;
    return (h("svg", { "data-test-id": "iconSortZA", class: `${props.pressed ? 'pressed' : ''}`, width: (_a = props.size) !== null && _a !== void 0 ? _a : 16, height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, fill: (_c = props.color) !== null && _c !== void 0 ? _c : 'currentColor', onClick: props.onClick, viewBox: "0 0 32 32" },
...
const ModusDataTable$1 = /*@__PURE__*/ proxyCustomElement(class ModusDataTable extends H {
    ...
    `;
        return (h$1("table", { key: 'd53f299f917ec5f6c4e0fb053c52d12a7d94ed02', class: className }, h$1("colgroup", { key: '8435c07dd1c6754ebbca29ba1967c063cf6ffdfd' }, this.selectionOptions.canSelect && this.selectionOptions.checkboxSelection && h$1("col", { style: { width: '34px' } }), (_a = this.columns) === null || _a === void 0 ? void 0 :
            _a.map((column) => (h$1("col", { style: { width: column.width } }))), !!this.rowActions.length && h$1("col", { style: { width: '34px' } })), h$1("thead", { key: 'c098e976be8cca8ee699776744fa8804a3bc2803' }, h$1("tr", { key: '5be24af7e8e9a1cee430a683f7c79e2b3cc552ea' }, this.selectionOptions.canSelect && this.selectionOptions.checkboxSelection && (h$1("th", null, h$1("div", { class: "column-header align-center" }, h$1("modus-checkbox", { checked: this.allSelected, onCheckboxClick: (e) => this.handleHeaderCheckboxClick(e.detail) })))), (_b = this.columns) === null || _b === void 0 ? void 0 :
            _b.map((column) => (h$1(ModusDataTableHeader, { column: column, onColumnHeaderClick: (id) => this.handleColumnHeaderClick(id), sortOptions: this.sortOptions, sortState: this.sortState }))), !!this.rowActions.length && h$1("th", null))), h$1("tbody", { key: 'cd8d983d7d804f126285ffa915c7910ff00b11b2' }, (_c = this.data) === null || _c === void 0 ? void 0 : _c.map((row) => {
            var _a;
            return (h$1("tr", { onClick: () => this.handleRowClick(row._id), onDblClick: () => this.handleRowDoubleClick(row._id) }, this.selectionOptions.canSelect && this.selectionOptions.checkboxSelection && (h$1("td", { class: `align-center ${row._selected ? 'selected' : ''}`, onClick: (e) => e.stopPropagation(), onDblClick: (e) => e.stopPropagation() }, h$1("div", null, h$1("modus-checkbox", { checked: row._selected, onCheckboxClick: () => this.handleCheckboxClick(row._id) })))), (_a = this.columns) === null || _a === void 0 ? void 0 :
                _a.map((column) => {
                    var _a, _b, _c, _d;
                    return (h$1("td", { class: `align-${column.align} ${column.readonly ? 'readonly' : ''} ${row._selected ? 'selected' : ''}` }, ((_a = row[column.id]) === null || _a === void 0 ? void 0 : _a._type) === 'link' && (h$1(ModusDataTableCellLinkPart, { link: row[column.id], onLinkClick: () => this.cellLinkClick.emit(row[column.id]) })), ((_b = row[column.id]) === null || _b === void 0 ? void 0 : _b._type) === 'badge' && h$1(ModusDataTableCellBadgePart, { badge: row[column.id] }), !((_c = row[column.id]) === null || _c === void 0 ? void 0 : _c._type) && ((_d = row[column.id]) === null || _d === void 0 ? void 0 : _d.toString())));
                }), !!this.rowActions.length && (h$1("td", { class: `align-center ${row._selected ? 'selected' : ''}`, onClick: (e) => e.stopPropagation(), onDblClick: (e) => e.stopPropagation() }, h$1(ModusDataTableRowActionDropdown, { actions: this.rowActions, animateDropdown: this.displayOptions.animateRowActionsDropdown, onRowActionClick: (actionId, rowId) => this.rowActionClick.emit({ actionId, rowId }), rowId: row._id })))));
        }))));
    }
