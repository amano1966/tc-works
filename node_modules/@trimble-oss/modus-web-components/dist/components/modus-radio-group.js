...
const ModusRadioGroup$1 = /*@__PURE__*/ proxyCustomElement(class ModusRadioGroup extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    render() {
        return (h$1("div", { key: 'f739d67545febe34e1b7f1895aafa8b640d8a23f', class: "modus-radio-group", "aria-label": this.ariaLabel }, this.radioButtons.map((radioButton, index) => {
            return (h$1(ModusRadioButton, { ref: (el) => (this.radioButtonRefs[index] = el), size: this.size, checked: radioButton.checked, disabled: radioButton.disabled, label: radioButton.label, name: this.name, id: radioButton.id, handleButtonClick: (id) => this.handleButtonClick(id), handleKeydown: (event, id) => this.handleButtonKeydown(event, id) }));
        })));
    }
