...
import { a as IconChevronLeft } from './p-518f3674.js';
import { h } from './p-5f965237.js';
import { d as defineCustomElement$5 } from './p-dca65392.js';
import { d as defineCustomElement$4 } from './p-34f769d6.js';
import { d as defineCustomElement$3 } from './p-66b5ff88.js';
...
const ModusSideNavigationTree = ({ data, itemSelected, tabIndex }) => {
    if (!(data === null || data === void 0 ? void 0 : data.length))
        return null;
    return data === null || data === void 0 ? void 0 : data.map(({ id, disabled, selected, label, menuIcon, children, onSideNavItemClicked, options, isHeader }) => {
...
const ModusSideNavigation$1 = /*@__PURE__*/ proxyCustomElement(class ModusSideNavigation extends H {
    ...
    render() {
        return (h$1("nav", { key: '7486843bbae056897a00afe0e2982cb59a86fc1c', class: `side-nav-panel${this.expanded ? ' expanded' : ''}`, style: { width: this.expanded ? this.maxWidth : null }, onKeyDown: (e) => this.handleKeyDown(e), "aria-label": "side navigation" }, this.data ? (h$1("div", { tabindex: -1, ref: (el) => this.handleLevelsContainerRef(el) }, this._navigationLevels.map((level, index) => (h$1("div", { class: `side-nav-level ${level.levelPosition}`, "aria-hidden": level.levelPosition !== 'center' ? 'true' : null }, index !== 0 && (h$1("div", Object.assign({ class: "level-heading" }, (level.levelPosition === 'center'
            ? {
                tabindex: 0,
                ref: (el) => this.handleLevelHeadingRef(el),
            }
            : {})), h$1("p", null, h$1(IconChevronLeft, { size: "24" }), h$1("a", { tabIndex: 0, onClick: (e) => this.handleBackClick(e), onKeyDown: (e) => this.handleBackClick(e) }, "Back")), h$1("h4", null, level.label))), h$1("div", null, h$1("ul", { class: "side-nav-menu", role: "tree" }, h$1(ModusSideNavigationTree, { data: level.children, itemSelected: this._itemSelected, tabIndex: level.levelPosition === 'center' ? undefined : -1 })))))))) : (h$1("div", { class: "side-nav-level center" }, h$1("ul", { class: "side-nav-menu", role: "tree" }, h$1("slot", null))))));
    }
...
function defineCustomElement$1() {
    ...
    const components = ["modus-side-navigation", "modus-list", "modus-list-item", "modus-side-navigation-item", "modus-tooltip"];
