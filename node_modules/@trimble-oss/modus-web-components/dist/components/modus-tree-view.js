...
import { T as TREE_ITEM_SIZE_CLASS } from './p-cfae6aaa.js';
...
const ModusTreeView$1 = /*@__PURE__*/ proxyCustomElement(class ModusTreeView extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
        ...
        this.enableReordering = undefined;
        this.expandedItems = [];
    ...
    handleChangeTreeitem(isSelected, nodeId) {
    ...
    handleItemSelection(itemId, event) {
        ...
        if (isSelected) {
            ...
            if (allowMultipleSelection)
                this.handleChangeTreeitem(false, itemId);
        }
    ...
    updateClickedItems(currentItemId, isShiftClick) {
    ...
    render() {
        return (h$1(Host, { key: '8f3612230fd3eabd0b06e0fff972defc8a77745b' }, h$1("ul", { key: '663ea4ab53a25618226649a61014c0b0385109a7', role: "tree", tabindex: this.disableTabbing ? 0 : null, onKeyDown: (e) => this.handleKeyDown(e) }, h$1("slot", { key: '1f30b5548cb1a2defa0faefe1f99da7b2dc59bb0', onSlotchange: () => this.handleTreeSlotChange() })), h$1(ModusContentTreeDragItem, { key: '56a14e7456ad2019ef4d8d21900181f6c654c7a4', draggingState: this.itemDragState }, h$1("div", { key: 'ab4f7d792b3420a835ae431adf28a6fd1c33dee2', class: "drag-indicator", tabIndex: -1 }))));
    }
    ...
    static get watchers() { return {
        ...
        "enableReordering": ["handleOptionsProps"]
    }; }
    static get style() { return ModusTreeViewStyle0; }
}, [1, "modus-tree-view", {
        "checkboxSelection": [4, "checkbox-selection"],
        "checkedItems": [1040],
        "disableTabbing": [1028, "disable-tabbing"],
        "enableReordering": [4, "enable-reordering"],
        "expandedItems": [1040],
        ...
        "borderless": [4],
        "itemDragState": [32],
        "isDraggingWithKeyboard": [32]
    }, [[4, "click", "handleDocumentClick"], [0, "itemAdded", "handleItemAdded"], [0, "actionClick", "handleItemClick"]], {
        "itemDragState": ["handleItemDragState"],
        "isDraggingWithKeyboard": ["handleDraggingWithKeyboard"],
        "expandedItems": ["handleItemsProps"],
        "selectedItems": ["handleItemsProps"],
