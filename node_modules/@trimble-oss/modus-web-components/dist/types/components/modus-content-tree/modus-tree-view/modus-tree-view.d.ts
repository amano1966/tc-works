...
import { TreeViewItemOptions, TreeViewItemInfo, TreeViewItemDragState, TreeItemSelectionChange, Position } from '../modus-content-tree.types';
export declare class ModusTreeView {
    ...
    itemSelectionChange: EventEmitter<TreeItemSelectionChange>;
    private currentItem;
    private anchorItemId;
    private focusItem;
    private items;
    private syncItems;
    private onMouseMove;
