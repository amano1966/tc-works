import { CellContext, ColumnDefTemplate, ColumnOrderState, ColumnSizingState, ColumnSort, ExpandedState, PaginationState, RowData, SortingFnOption, SortingState, VisibilityState } from '@tanstack/table-core';
import { BadgeProperties } from '../../modus-badge/modus-badge';
import { COLUMN_DEF_DATATYPE_INTEGER, COLUMN_DEF_DATATYPE_LINK, COLUMN_DEF_DATATYPE_TEXT, COLUMN_DEF_DATATYPE_BADGE, CELL_EDIT_TYPE_SELECT, CELL_EDIT_TYPE_DATE, CELL_EDIT_TYPE_AUTOCOMPLETE, CELL_EDIT_TYPE_INT, CELL_EDIT_TYPE_TEXT, COLUMN_DEF_DATATYPE_CUSTOM } from '../modus-table.constants';
...
export type ModusTableColumnDataType = typeof COLUMN_DEF_DATATYPE_TEXT | typeof COLUMN_DEF_DATATYPE_INTEGER | typeof COLUMN_DEF_DATATYPE_LINK | typeof COLUMN_DEF_DATATYPE_BADGE;
export type ModusTableCellEditorType = typeof CELL_EDIT_TYPE_SELECT | typeof CELL_EDIT_TYPE_TEXT | typeof CELL_EDIT_TYPE_INT | typeof CELL_EDIT_TYPE_AUTOCOMPLETE | typeof CELL_EDIT_TYPE_DATE;
export type ModusTableCellDateEditorArgs = {
    format: string;
