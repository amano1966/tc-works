...
export class ModusTreeView {
    ...
    render() {
        return (h(Host, { key: '8f3612230fd3eabd0b06e0fff972defc8a77745b' }, h("ul", { key: '663ea4ab53a25618226649a61014c0b0385109a7', role: "tree", tabindex: this.disableTabbing ? 0 : null, onKeyDown: (e) => this.handleKeyDown(e) }, h("slot", { key: '1f30b5548cb1a2defa0faefe1f99da7b2dc59bb0', onSlotchange: () => this.handleTreeSlotChange() })), h(ModusContentTreeDragItem, { key: '56a14e7456ad2019ef4d8d21900181f6c654c7a4', draggingState: this.itemDragState }, h("div", { key: 'ab4f7d792b3420a835ae431adf28a6fd1c33dee2', class: "drag-indicator", tabIndex: -1 }))));
    }
    ...
    static get properties() {
        return {
            ...
            "enableReordering": {
                ...
                "docs": {
                    "tags": [],
                    "text": "(optional) Sets draggable state to be true to all the children"
                },
                "attribute": "enable-reordering",
                "reflect": false
            },
            "expandedItems": {
                "type": "unknown",
            ...
            "borderless": {
                ...
                "docs": {
                    "tags": [],
                    "text": "(optional) Whether the content tree and items have a border or not"
                },
    ...
    static get events() {
        return [{
                ...
                "complexType": {
                    "original": "{ [key: string]: TreeViewItemInfo }",
                    "resolved": "{ [key: string]: TreeViewItemInfo; }",
                    "references": {
                        "TreeViewItemInfo": {
                            "location": "import",
                            "path": "../modus-content-tree.types",
                            "id": "src/components/modus-content-tree/modus-content-tree.types.tsx::TreeViewItemInfo"
                        }
                    }
                }
            }, {
                ...
                "docs": {
                    "tags": [],
                    "text": "Fired when an action is clicked within any tree item. Includes both the `actionId` and `nodeId` of the action and item, respectively."
                },
                "complexType": {
                    "original": "any",
                    "resolved": "any",
    ...
    static get watchers() {
        return [{
                ...
                "propName": "isDraggingWithKeyboard",
                "methodName": "handleDraggingWithKeyboard"
            }, {
