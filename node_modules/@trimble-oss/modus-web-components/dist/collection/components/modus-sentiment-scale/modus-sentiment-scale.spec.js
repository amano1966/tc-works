      ...
      <modus-sentiment-scale type="thumbs">
        <mock:shadow-root>
          ...
          <div aria-label="Helpful" class="thumbs-container" role="button" tabindex="0">
             <svg class="icon-thumbs-up-outlined" fill="none" height="32" viewBox="0 0 24 24" width="32">
           ...
           <div aria-label="Not helpful" class="thumbs-container" role="button" tabindex="0">
             <svg class="icon-thumbs-down-outlined" fill="none" height="32" viewBox="0 0 24 24" width="32">
        ...
        <mock:shadow-root>
          <div class="sentiment-scale-container" role="group">
            <div aria-label="Dissatisfied" class="smileys-container" role="button" tabindex="0">
              <svg class="icon-smiley-dissatistied-outline" fill="none" height="24" viewBox="0 0 24 24" width="24">
            ...
            <div aria-label="Somewhat Dissatisfied" class="smileys-container" role="button" tabindex="0">
              <svg class="icon-smiley-somewhat-dissatistied-outline" fill="none" height="24" viewBox="0 0 24 24" width="24">
            ...
            <div aria-label="Neutral" class="smileys-container" role="button" tabindex="0">
              <svg class="icon-smiley-neutral-outline" fill="none" height="24" viewBox="0 0 24 24" width="24">
            ...
            <div aria-label="Somewhat Satisfied" class="smileys-container" role="button" tabindex="0">
              <svg class="icon-smiley-somewhat-satistied-outline" fill="none" height="24" viewBox="0 0 24 24" width="24">
            ...
            <div aria-label="Satisfied" class="smileys-container" role="button" tabindex="0">
              <svg class="icon-smiley-satistied-outline" fill="none" height="24" viewBox="0 0 24 24" width="24">
