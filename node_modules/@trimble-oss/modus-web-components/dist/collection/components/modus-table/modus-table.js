    ...
    static get properties() {
        return {
            ...
            "errors": {
                ...
                "mutable": false,
                "complexType": {
                    "original": "ModusTableErrors",
                    "resolved": "ModusTableErrors",
                    "references": {
                        "ModusTableErrors": {
                            "location": "import",
                            "path": "./models/modus-table.models",
                            "id": "src/components/modus-table/models/modus-table.models.ts::ModusTableErrors"
                        }
                    }
                },
                "required": false,
            ...
            "rowActionsConfig": {
                ...
                "mutable": false,
                "complexType": {
                    "original": "ModusTableRowActionConfig",
                    "resolved": "ModusTableRowActionConfig",
                    "references": {
                        "ModusTableRowActionConfig": {
                            "location": "import",
                            "path": "./models/modus-table.models",
                            "id": "src/components/modus-table/models/modus-table.models.ts::ModusTableRowActionConfig"
                        }
                    }
                },
                "required": false,
                ...
                "docs": {
                    "tags": [],
                    "text": "(Optional) The width and header of the rowActionsConfig."
                }
            },
            "rowsExpandable": {
                "type": "boolean",
            ...
            "rowSelectionDisabled": {
                ...
                "mutable": false,
                "complexType": {
                    "original": "(row: Row<unknown>) => boolean",
                    "resolved": "(row: Row<unknown>) => boolean",
                    "references": {
                        "Row": {
                            "location": "import",
                ...
                "docs": {
                    "tags": [],
                    "text": "(Optional) Function to determine if a row is disabled for selection."
                }
            }
        };
    }
            ...
            "toggleAllRowsSelection": {
                "complexType": {
                    ...
                    "parameters": [{
                            "name": "select",
                            "type": "boolean",
                            "docs": "- `true` to select all rows, `false` to deselect them."
                        }],
                    "references": {
                        "Promise": {
                            "location": "global",
                ...
                "docs": {
                    "text": "Selects or deselects all rows in the table.",
                    "tags": [{
                            "name": "param",
                            "text": "select - `true` to select all rows, `false` to deselect them."
                        }, {
                            "name": "returns",
                            "text": "A promise that resolves when the operation is complete."
                        }, {
                            "name": "example",
                            "text": "await toggleAllRowsSelection(true);  // Select all\nawait toggleAllRowsSelection(false); // Deselect all"
                        }]
                }
            },
            "getEditableCell": {
