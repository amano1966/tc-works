...
describe('modus-modal', () => {
    it('renders', async () => {
        const { root } = await newSpecPage({
            ...
            html: '<modus-modal show-fullscreen-toggle=true></modus-modal>',
        });
        expect(root).toEqualHtml(` <modus-modal show-fullscreen-toggle=true>
      <mock:shadow-root>
              ...
              <div class="header-buttons">
                <div aria-label="Expand" role="button" tabindex="0">
                  ...
                  <div role="button" tabindex="0" aria-label="Close">
                    <svg class="icon-close" height="24" width="24" viewBox="0 0 24 24" fill="none">
    ...
    it('should update isContentScrollable when content changes', async () => {
        ...
        const modalBody = page.root.shadowRoot.querySelector('.body');
