...
describe('icon-accessibility-circle', () => {
    it('should render', async () => {
        const page = await renderFunctionalComponentToSpecPage(h(IconAccessibilityCircle, null));
        expect(page.root).toEqualHtml(`
    ...
    it('should render correct size', async () => {
        const page = await renderFunctionalComponentToSpecPage(h(IconAccessibilityCircle, { size: "12" }));
        expect(page.root).toEqualHtml(`
...
describe('icon-file-bar-graph', () => {
    it('should render', async () => {
        const page = await renderFunctionalComponentToSpecPage(h(IconFileBarGraph, null));
        expect(page.root).toEqualHtml(`
    ...
    it('should render correct size', async () => {
        const page = await renderFunctionalComponentToSpecPage(h(IconFileBarGraph, { size: "12" }));
        expect(page.root).toEqualHtml(`
