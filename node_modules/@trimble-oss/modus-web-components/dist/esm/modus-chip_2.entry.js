...
import { I as IconCheck } from './icon-check-d285df73.js';
...
const ModusSpinner = class {
    ...
    render() {
        const borderColor = this.variants.has(this.color)
            ...
            : this.color;
        return (h("div", { key: '70cb7810d3944b16c2e72ebdbd4c96360322b114', "aria-busy": "true", class: "spinner", style: {
...
export { ModusChip as modus_chip, ModusSpinner as modus_spinner };
