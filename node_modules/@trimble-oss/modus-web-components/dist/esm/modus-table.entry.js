import { h, r as registerInstance, c as createEvent, F as Fragment, H as Host, g as getElement } from './index-612c46d2.js';
import { C as COLUMN_DEF_ROW_SELECTION_ID, a as COLUMN_DEF_ROW_SELECTION_CSS, b as COLUMN_DEF_DATATYPE_KEY, c as COLUMN_DEF_DATATYPE_INTEGER, d as COLUMN_DEF_SHOWTOTAL, K as KEYBOARD_RIGHT, e as KEYBOARD_LEFT, f as KEYBOARD_ENTER, g as KEYBOARD_ESCAPE, h as KEYBOARD_TAB, H as HTML_ATTR_DATA_ACCESSOR_KEY, i as COLUMN_DEF_SUB_ROWS_KEY, j as KEYBOARD_SPACE, P as PAGINATION_DEFAULT_SIZES, E as EXPANDED_STATE_KEY, S as SORTING_STATE_KEY, k as PAGINATION_STATE_KEY, l as COLUMN_SIZING_STATE_KEY, m as COLUMN_VISIBILITY_STATE_KEY, n as COLUMN_ORDER_STATE_KEY, R as ROW_SELECTION_STATE_KEY, o as COLUMN_SIZING_INFO_STATE_KEY } from './modus-table.constants-3cf5de92.js';
...
const ModusTable = class {
    ...
    render() {
        var _a;
        return (h(Host, { key: 'b0a13e34ef5f00b38444bca8bc5193c3032a96f8', id: this._id }, h("div", { key: '41fb8cc396890e63431d3d851a84181c338977f9', style: { maxWidth: this.maxWidth } }, this.renderToolBar(), this.renderMain(), this.renderPagination(), h(ModusTableColumnDragItem, { key: '6e28094e11b7446b82b83d3ecd0a92c45b5d7767', draggingState: this.itemDragState }), h(ModusTableColumnDropIndicator, { key: '4b2b34a68f4527244eefc436fdaac4631635c7b3', position: (_a = this.itemDragState) === null || _a === void 0 ? void 0 : _a.dropIndicator }), h("modus-table-row-actions-menu", { key: '8440d7ac598601cf22f2420220c4058705754cc1', context: this._context }))));
    }
