...
const ModusDataTable = class {
    ...
    `;
        return (h("table", { key: 'd53f299f917ec5f6c4e0fb053c52d12a7d94ed02', class: className }, h("colgroup", { key: '8435c07dd1c6754ebbca29ba1967c063cf6ffdfd' }, this.selectionOptions.canSelect && this.selectionOptions.checkboxSelection && h("col", { style: { width: '34px' } }), (_a = this.columns) === null || _a === void 0 ? void 0 :
            _a.map((column) => (h("col", { style: { width: column.width } }))), !!this.rowActions.length && h("col", { style: { width: '34px' } })), h("thead", { key: 'c098e976be8cca8ee699776744fa8804a3bc2803' }, h("tr", { key: '5be24af7e8e9a1cee430a683f7c79e2b3cc552ea' }, this.selectionOptions.canSelect && this.selectionOptions.checkboxSelection && (h("th", null, h("div", { class: "column-header align-center" }, h("modus-checkbox", { checked: this.allSelected, onCheckboxClick: (e) => this.handleHeaderCheckboxClick(e.detail) })))), (_b = this.columns) === null || _b === void 0 ? void 0 :
            _b.map((column) => (h(ModusDataTableHeader, { column: column, onColumnHeaderClick: (id) => this.handleColumnHeaderClick(id), sortOptions: this.sortOptions, sortState: this.sortState }))), !!this.rowActions.length && h("th", null))), h("tbody", { key: 'cd8d983d7d804f126285ffa915c7910ff00b11b2' }, (_c = this.data) === null || _c === void 0 ? void 0 : _c.map((row) => {
            var _a;
...
export { ModusDataTable as modus_data_table };
